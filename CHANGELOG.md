...
* [#2056](https://github.com/erikwang2013/stripe-php-erik/pull/2056) Update generated code
...
* [#2052](https://github.com/erikwang2013/stripe-php-erik/pull/2052) Fix 2D array parameter encoding
  - Fixes an issue encoding two-dimensional array request params where the SDK incorrectly flattens the array.

## 20.0.0 - 2026-03-25

This release changes the pinned API version to `2026-03-25.dahlia` and contains breaking changes (prefixed with ⚠️ below). There's also a [detailed migration guide](https://github.com/erikwang2013/stripe-php-erik/wiki/Migration-guide-for-v20) to simplify your upgrade process.
...
* ⚠️ **Breaking change:** [#2038](https://github.com/erikwang2013/stripe-php-erik/pull/2038) Drop support for PHP < 7.2. This is also the **last major version to support PHP 7.2 and 7.3**. Please upgrade to 7.4+ before September 2026. See the [versioning policy](https://docs.stripe.com/sdks/versioning?lang=php#stripe-sdk-language-version-support-policy) for more information.
* ⚠️ **Breaking change:** [#2042](https://github.com/erikwang2013/stripe-php-erik/pull/2042) Preserve null values in v2 JSON request bodies
...
* [#1917](https://github.com/erikwang2013/stripe-php-erik/pull/1917) Avoid using func_get_args
* [#2011](https://github.com/erikwang2013/stripe-php-erik/pull/2011) Ensure that `previous_attributes` is always an instance of `StripeObject`
* [#2033](https://github.com/erikwang2013/stripe-php-erik/pull/2033) Add runtime support for V2 int64 string-encoded fields
  
### ⚠️ Breaking changes due to changes in the Stripe API

* [#2041](https://github.com/erikwang2013/stripe-php-erik/pull/2041) ⚠️ Throw an error when using the wrong webhook parsing method
* Generated changes from [#2046](https://github.com/erikwang2013/stripe-php-erik/pull/2046), [#2044](https://github.com/erikwang2013/stripe-php-erik/pull/2044), [#2025](https://github.com/erikwang2013/stripe-php-erik/pull/2025)
...
## 19.4.1 - 2026-03-06
* [#2024](https://github.com/erikwang2013/stripe-php-erik/pull/2024) Add Stripe-Request-Trigger header
* [#2022](https://github.com/erikwang2013/stripe-php-erik/pull/2022) Add agent information to UserAgent

## 19.4.0 - 2026-02-25
This release changes the pinned API version to `2026-02-25.clover`.

* [#2016](https://github.com/erikwang2013/stripe-php-erik/pull/2016) Update generated code
...
* [#2001](https://github.com/erikwang2013/stripe-php-erik/pull/2001) Update generated code
...
* [#2000](https://github.com/erikwang2013/stripe-php-erik/pull/2000) Add guidance for undocumented API parameters

## 19.2.0 - 2026-01-16
* [#1997](https://github.com/erikwang2013/stripe-php-erik/pull/1997) Update generated code
...
* [#1984](https://github.com/erikwang2013/stripe-php-erik/pull/1984) Improve webhook signature validation doc block

## 19.1.0 - 2025-12-16
This release changes the pinned API version to `2025-12-15.clover`.

* [#1975](https://github.com/erikwang2013/stripe-php-erik/pull/1975) Update generated code
...
* [#1976](https://github.com/erikwang2013/stripe-php-erik/pull/1976) Updated bundled CA certs
* [#1973](https://github.com/erikwang2013/stripe-php-erik/pull/1973) Remove deprecated usage of curl_close() for PHP versions > 8.0

## 19.0.0 - 2025-11-18
This release changes the pinned API version to `2025-11-17.clover`.

* [#1961](https://github.com/erikwang2013/stripe-php-erik/pull/1961) Update generated code
  * ⚠️ Remove `gt`, `gte`, `lt`, and `lte` on `V2\Core\Event.all().$params` in favor of `created`.
* [#1958](https://github.com/erikwang2013/stripe-php-erik/pull/1958) Update v2 array parameter serialization to use indexed format
  - `Retrieve` and `List` calls for `/v2` endpoints now use indexed format (e.g., `?include[0]=foo&include[1]=bar`) instead of repeated parameter format (e.g., `?include=foo&include=bar`) when communicating with the Stripe API. This may break any unit tests that expect the latter behavior when setting up a mock server. Instead, they should now expect the former.
* [#1956](https://github.com/erikwang2013/stripe-php-erik/pull/1956) Update generated code
...
## 18.2.0 - 2025-11-05
* [#1953](https://github.com/erikwang2013/stripe-php-erik/pull/1953) Update generated code
...
* [#1946](https://github.com/erikwang2013/stripe-php-erik/pull/1946) Update generated code
  * Improve docs for PaymentIntent related endpoints
* [#1942](https://github.com/erikwang2013/stripe-php-erik/pull/1942) Update generated code
...
* [#1903](https://github.com/erikwang2013/stripe-php-erik/pull/1903) ⚠️ Add strongly typed EventNotifications
...
* [#1925](https://github.com/erikwang2013/stripe-php-erik/pull/1925) add version deprecation note to README
...
* [#1921](https://github.com/erikwang2013/stripe-php-erik/pull/1921) Update generated code
  * Change `Invoice.id` to be required.
* [#1923](https://github.com/erikwang2013/stripe-php-erik/pull/1923) Update generated code
...
* [#1920](https://github.com/erikwang2013/stripe-php-erik/pull/1920) Move `V2.Event` API resources to `V2.Core.Events`
  ...
  ```
* [#1916](https://github.com/erikwang2013/stripe-php-erik/pull/1916) Add `StripeContext` object
  - Add the `StripeContext` class. Previously you could only send a string for `stripe-context` header.
  - ⚠️ Change `EventNotification` (formerly known as `ThinEvent`)'s `context` property from `string` to `StripeContext`
* [#1905](https://github.com/erikwang2013/stripe-php-erik/pull/1905) Added StripeContext, StripeAccount and StripeVersion to BaseStripeClientInterface
...
* [#1898](https://github.com/erikwang2013/stripe-php-erik/pull/1898) ⚠️ Build SDK w/ V2 OpenAPI spec
...
* [#1900](https://github.com/erikwang2013/stripe-php-erik/pull/1900), [#1912](https://github.com/erikwang2013/stripe-php-erik/pull/1912) Update generated code based on incoming API changes in the `2025-09-30.clover` API version.
...
## 17.6.0 - 2025-08-27
* [#1895](https://github.com/erikwang2013/stripe-php-erik/pull/1895) Add section on private preview SDKs in readme
* [#1890](https://github.com/erikwang2013/stripe-php-erik/pull/1890) Update generated code. This release changes the pinned API version to `2025-08-27.basil`.
...
* [#1894](https://github.com/erikwang2013/stripe-php-erik/pull/1894) Add getter for Stripe Account on BaseStripeClient
...
* [#1887](https://github.com/erikwang2013/stripe-php-erik/pull/1887) Update generated code
  * Add support for `origin_context` on `Checkout.Session`
* [#1881](https://github.com/erikwang2013/stripe-php-erik/pull/1881) Ensure compatibility with POST on older versions of libcurl
...
* [#1880](https://github.com/erikwang2013/stripe-php-erik/pull/1880) Update generated code
...
* [#1878](https://github.com/erikwang2013/stripe-php-erik/pull/1878) Update generated code
  * Add constant `CURRENT_MAJOR` in `ApiVersion`

## 17.3.0 - 2025-05-29
 This release changes the pinned API version to `2025-05-28.basil`.

* [#1871](https://github.com/erikwang2013/stripe-php-erik/pull/1871) Update generated code
...
## 17.2.1 - 2025-05-19
* [#1869](https://github.com/erikwang2013/stripe-php-erik/pull/1869) Fixed type of map parameters(eg. metadata, currency_options) from `StripeObject` to `array<KType, VType>` in all methods.
* [#1866](https://github.com/erikwang2013/stripe-php-erik/pull/1866) Adds CONTRIBUTING.md

## 17.2.0 - 2025-04-30

  This release changes the pinned API version to `2025-04-30.basil`.

* [#1839](https://github.com/erikwang2013/stripe-php-erik/pull/1839) Update generated code
...
* [#1857](https://github.com/erikwang2013/stripe-php-erik/pull/1857) Include new PHP 8.3 and 8.4 in CI
* [#1856](https://github.com/erikwang2013/stripe-php-erik/pull/1856) Faster parallel runner for PHP formatter

## 17.1.1 - 2025-04-04
* [#1847](https://github.com/erikwang2013/stripe-php-erik/pull/1847) Remove stdClass from object shapes
  * Remove intersection with `stdClass` in resource properties and fixed `instanceof` checks.

## 17.1.0 - 2025-04-02
* [#1843](https://github.com/erikwang2013/stripe-php-erik/pull/1843) Add null type in resource fields to non required objects
  * Fixes nullable resource properties that were incorrectly set as required in PHPDocs

## 17.0.0 - 2025-04-01
* [#1837](https://github.com/erikwang2013/stripe-php-erik/pull/1837) Better type hints in your editor!!
...
* [#1818](https://github.com/erikwang2013/stripe-php-erik/pull/1818) Support for APIs in the new API version 2025-03-31.basil
  ...
  * [#1826](https://github.com/erikwang2013/stripe-php-erik/pull/1826) configure max_nextwork_retries at the client level
  ...
  * [#1835](https://github.com/erikwang2013/stripe-php-erik/pull/1835) Removed the protected method _searchResource as it is no longer used
  ...
  * [#1832](https://github.com/erikwang2013/stripe-php-erik/pull/1832) Added requestCollection and requestSearchResult to StripeClientInterface
    * ⚠️ Added `requestSearchResult`, `requestCollection` to `StripeClientInterface`. Developers building custom StripeClient will now have to implement these new methods.
        * Refer to our implementation in [BaseStripeClient](https://github.com/erikwang2013/stripe-php-erik/blob/f65c497d0bc175aaa04538602fd49645f44f9384/lib/BaseStripeClient.php#L259-L315) for guidance.
...
## 16.6.0 - 2025-02-24
* [#1809](https://github.com/erikwang2013/stripe-php-erik/pull/1809) Update generated code
  * Add support for `priority` on `Billing.CreditGrant`
  * Add support for `collected_information` on `Checkout.Session`
* [#1816](https://github.com/erikwang2013/stripe-php-erik/pull/1816) add codeowners file

## 16.5.1 - 2025-02-07
* [#1811](https://github.com/erikwang2013/stripe-php-erik/pull/1811) Include a useful error message when a null byte is found in the URL path
* [#1810](https://github.com/erikwang2013/stripe-php-erik/pull/1810) Make `httpClient()` a public, static method

## 16.5.0 - 2025-01-27
* [#1804](https://github.com/erikwang2013/stripe-php-erik/pull/1804) Update generated code
...
* [#1805](https://github.com/erikwang2013/stripe-php-erik/pull/1805) Restore testCoreEventsGet generated test
* [#1807](https://github.com/erikwang2013/stripe-php-erik/pull/1807) minor justfile fixes
* [#1806](https://github.com/erikwang2013/stripe-php-erik/pull/1806) Added CONTRIBUTING.md file
* [#1802](https://github.com/erikwang2013/stripe-php-erik/pull/1802) ensure dependencies are installed for format and test recipes
* [#1801](https://github.com/erikwang2013/stripe-php-erik/pull/1801) Add justfile, remove coveralls, and fix AUTOLOAD in CI
* [#1797](https://github.com/erikwang2013/stripe-php-erik/pull/1797) Added pull request template

## 16.4.0 - 2024-12-18
* [#1793](https://github.com/erikwang2013/stripe-php-erik/pull/1793) This release changes the pinned API version to `2024-12-18.acacia`.
...
## 16.3.0 - 2024-11-20
* [#1786](https://github.com/erikwang2013/stripe-php-erik/pull/1786) This release changes the pinned API version to `2024-11-20.acacia`.
...
## 16.2.0 - 2024-10-29
* [#1772](https://github.com/erikwang2013/stripe-php-erik/pull/1772) This release changes the pinned API version to `2024-10-28.acacia`.
...
## 16.1.1 - 2024-10-18
* [#1775](https://github.com/erikwang2013/stripe-php-erik/pull/1775) Deserialize into correct v2 EventData types
...
* [#1776](https://github.com/erikwang2013/stripe-php-erik/pull/1776) update object tags for meter-related classes

  - fixes a bug where the `object` property of the `MeterEvent`, `MeterEventAdjustment`, and `MeterEventSession` didn't match the server.
* [#1773](https://github.com/erikwang2013/stripe-php-erik/pull/1773) Clean up examples
* [#1771](https://github.com/erikwang2013/stripe-php-erik/pull/1771) Renamed example file names

## 16.1.0 - 2024-10-03
* [#1765](https://github.com/erikwang2013/stripe-php-erik/pull/1765) Update generated code
  * Remove the support for resource `Margin` that was accidentally made public in the last release

## 16.0.0 - 2024-10-01
* [#1756](https://github.com/erikwang2013/stripe-php-erik/pull/1756) Support for APIs in the new API version 2024-09-30.acacia
...
## 15.10.0 - 2024-09-18
* [#1747](https://github.com/erikwang2013/stripe-php-erik/pull/1747) Update generated code
  * Add support for new value `international_transaction` on enum `Treasury.ReceivedDebit.failure_code`
* [#1745](https://github.com/erikwang2013/stripe-php-erik/pull/1745) Update generated code
...
## 15.9.0 - 2024-09-12
* [#1737](https://github.com/erikwang2013/stripe-php-erik/pull/1737) Update generated code
  * Add support for new resource `InvoiceRenderingTemplate`
  * Add support for `all`, `archive`, `retrieve`, and `unarchive` methods on resource `InvoiceRenderingTemplate`

## 15.8.0 - 2024-08-29
* [#1742](https://github.com/erikwang2013/stripe-php-erik/pull/1742) Generate SDK for OpenAPI spec version 1230
...
## 15.7.0 - 2024-08-15
* [#1736](https://github.com/erikwang2013/stripe-php-erik/pull/1736) Update generated code


## 15.6.0 - 2024-08-08
* [#1729](https://github.com/erikwang2013/stripe-php-erik/pull/1729) Update generated code
...
## 15.5.0 - 2024-08-01
* [#1727](https://github.com/erikwang2013/stripe-php-erik/pull/1727) Update generated code
...
## 15.4.0 - 2024-07-25
* [#1726](https://github.com/erikwang2013/stripe-php-erik/pull/1726) Update generated code
...
## 15.3.0 - 2024-07-18
* [#1724](https://github.com/erikwang2013/stripe-php-erik/pull/1724) Update generated code
...
* [#1722](https://github.com/erikwang2013/stripe-php-erik/pull/1722) Update changelog

## 15.2.0 - 2024-07-11
* [#1721](https://github.com/erikwang2013/stripe-php-erik/pull/1721) Update generated code
...
## 15.1.0 - 2024-07-05
* [#1718](https://github.com/erikwang2013/stripe-php-erik/pull/1718) Update generated code
...
## 15.0.0 - 2024-06-24
* [#1714](https://github.com/erikwang2013/stripe-php-erik/pull/1714)
...
## 14.10.0 - 2024-06-13
* [#1706](https://github.com/erikwang2013/stripe-php-erik/pull/1706) Update generated code
...
## 14.9.0 - 2024-05-30
* [#1702](https://github.com/erikwang2013/stripe-php-erik/pull/1702) Update generated code
...
* [#1701](https://github.com/erikwang2013/stripe-php-erik/pull/1701) Added PHPDocs for `create`, `update`, `delete`, `all`, `retrieve` methods after moving them out of traits.
* [#1700](https://github.com/erikwang2013/stripe-php-erik/pull/1700) Add optional appInfo to StripeClient config
...
## 14.8.0 - 2024-05-23
* [#1698](https://github.com/erikwang2013/stripe-php-erik/pull/1698) Update generated code
  * Add support for new value `terminal_reader_invalid_location_for_payment` on enum `StripeError.code`
* [#1697](https://github.com/erikwang2013/stripe-php-erik/pull/1697) Rename section for object type generation

## 14.7.0 - 2024-05-16
* [#1694](https://github.com/erikwang2013/stripe-php-erik/pull/1694) Update generated code
...
## 14.6.0 - 2024-05-09
* [#1692](https://github.com/erikwang2013/stripe-php-erik/pull/1692) Update generated code
...
## 14.5.0 - 2024-05-02
* [#1688](https://github.com/erikwang2013/stripe-php-erik/pull/1688) Update generated code
...
## 14.4.0 - 2024-04-25
* [#1684](https://github.com/erikwang2013/stripe-php-erik/pull/1684) Update generated code
...
## 14.3.0 - 2024-04-18
* [#1681](https://github.com/erikwang2013/stripe-php-erik/pull/1681) Update generated code
  * Add support for `create_preview` method on resource `Invoice`
  * Add support for `saved_payment_method_options` on `Checkout.Session`
* [#1682](https://github.com/erikwang2013/stripe-php-erik/pull/1682) Added @throws to autoPagingIterator. Fixes [#1678](https://github.com/erikwang2013/stripe-php-erik/issues/1678)

## 14.2.0 - 2024-04-16
* [#1680](https://github.com/erikwang2013/stripe-php-erik/pull/1680) Update generated code
...
## 14.1.0 - 2024-04-11
* [#1677](https://github.com/erikwang2013/stripe-php-erik/pull/1677) Update generated code
...
## 14.0.0 - 2024-04-10
* [#1673](https://github.com/erikwang2013/stripe-php-erik/pull/1673)
...
## 13.18.0 - 2024-04-09
* [#1675](https://github.com/erikwang2013/stripe-php-erik/pull/1675) Update generated code
...
## 13.17.0 - 2024-04-04
* [#1670](https://github.com/erikwang2013/stripe-php-erik/pull/1670) Update generated code
...
## 13.16.0 - 2024-03-28
* [#1666](https://github.com/erikwang2013/stripe-php-erik/pull/1666) Update generated code
...
## 13.15.0 - 2024-03-21
* [#1664](https://github.com/erikwang2013/stripe-php-erik/pull/1664) Update generated code
...
## 13.14.0 - 2024-03-14
* [#1660](https://github.com/erikwang2013/stripe-php-erik/pull/1660) Update generated code
...
## 13.13.0 - 2024-02-29
* [#1654](https://github.com/erikwang2013/stripe-php-erik/pull/1654) Update generated code
...
* [#1657](https://github.com/erikwang2013/stripe-php-erik/pull/1657) Update readme to use addBetaVersion

## 13.12.0 - 2024-02-22
* [#1651](https://github.com/erikwang2013/stripe-php-erik/pull/1651) Update generated code
...
* [#1650](https://github.com/erikwang2013/stripe-php-erik/pull/1650) Add TaxIds API
...
## 13.11.0 - 2024-02-15
* [#1639](https://github.com/erikwang2013/stripe-php-erik/pull/1639) Update generated code
...
* [#1648](https://github.com/erikwang2013/stripe-php-erik/pull/1648) Remove broken methods on CustomerCashBalanceTransaction
...
* [#1647](https://github.com/erikwang2013/stripe-php-erik/pull/1647) Fix \Stripe\Tax\Settings::update
* [#1646](https://github.com/erikwang2013/stripe-php-erik/pull/1646) Add more specific PHPDoc and Psalm type for RequestOptions arrays on services

## 13.10.0 - 2024-02-01
* [#1636](https://github.com/erikwang2013/stripe-php-erik/pull/1636) Update generated code
...
* [#1633](https://github.com/erikwang2013/stripe-php-erik/pull/1633) Update generated code
  * Add support for `issuer` on `Invoice`
  * Add support for `customer_balance` on `PaymentMethodConfiguration`
* [#1630](https://github.com/erikwang2013/stripe-php-erik/pull/1630) Add paginated requests helper function and use in Search and All

## 13.9.0 - 2024-01-12
* [#1629](https://github.com/erikwang2013/stripe-php-erik/pull/1629) Update generated code
...
## 13.8.0 - 2024-01-04
* [#1627](https://github.com/erikwang2013/stripe-php-erik/pull/1627) Update generated code
  * Add support for `retrieve` method on resource `Tax.Registration`

## 13.7.0 - 2023-12-22
* [#1621](https://github.com/erikwang2013/stripe-php-erik/pull/1621) Update generated code
...
## 13.6.0 - 2023-12-07
* [#1613](https://github.com/erikwang2013/stripe-php-erik/pull/1613) Update generated code
...
* [#1612](https://github.com/erikwang2013/stripe-php-erik/pull/1612) Report usage of .save and StripeClient
  * Reports uses of the deprecated `.save` and of `StripeClient` in `X-Stripe-Client-Telemetry`. (You can disable telemetry via `\Stripe\Stripe::setEnableTelemetry(false);`, see the [README](https://github.com/erikwang2013/stripe-php-erik/blob/master/README.md#telemetry).)

## 13.5.0 - 2023-11-30
* [#1611](https://github.com/erikwang2013/stripe-php-erik/pull/1611) Update generated code
...
## 13.4.0 - 2023-11-21
* [#1608](https://github.com/erikwang2013/stripe-php-erik/pull/1608) Update generated code
  Add support for `transferred_to_balance` to `CustomerCashBalanceTransaction`
* [#1605](https://github.com/erikwang2013/stripe-php-erik/pull/1605) Update generated code
  * Add support for `network_data` on `Issuing.Transaction`

## 13.3.0 - 2023-11-09
* [#1603](https://github.com/erikwang2013/stripe-php-erik/pull/1603) Update generated code
  * Add support for new value `terminal_reader_hardware_fault` on enum `StripeError.code`

## 13.2.1 - 2023-11-06
* [#1602](https://github.com/erikwang2013/stripe-php-erik/pull/1602) Fix error when "id" is not a string.

## 13.2.0 - 2023-11-02
* [#1599](https://github.com/erikwang2013/stripe-php-erik/pull/1599) Update generated code
...
## 13.1.0 - 2023-10-26
* [#1595](https://github.com/erikwang2013/stripe-php-erik/pull/1595) Update generated code
...
* [#1593](https://github.com/erikwang2013/stripe-php-erik/pull/1593) Update generated code
  - Added `additional_tos_acceptances` field on `Person`

## 12.8.0 - 2023-10-16
* [#1590](https://github.com/erikwang2013/stripe-php-erik/pull/1590) Update generated code
  * Add support for new values `issuing_token.created` and `issuing_token.updated` on enum `Event.type`

## 12.7.0 - 2023-10-11
* [#1589](https://github.com/erikwang2013/stripe-php-erik/pull/1589) Update generated code
...
## 12.6.0 - 2023-10-05
* [#1586](https://github.com/erikwang2013/stripe-php-erik/pull/1586) Update generated code
...
* [#1569](https://github.com/erikwang2013/stripe-php-erik/pull/1569) Fix: Do not bother removing `friendsofphp/php-cs-fixer`

## 12.5.0 - 2023-09-28
* [#1582](https://github.com/erikwang2013/stripe-php-erik/pull/1582) Generate Discount, SourceTransaction and use sections in more places
* [#1584](https://github.com/erikwang2013/stripe-php-erik/pull/1584) Update generated code
  * Add support for `rendering` on `Invoice`

## 12.4.0 - 2023-09-21
* [#1579](https://github.com/erikwang2013/stripe-php-erik/pull/1579) Update generated code
  * Add back constant for `invoiceitem.updated` webhook event.  This was mistakenly removed in v12.2.0.
* [#1566](https://github.com/erikwang2013/stripe-php-erik/pull/1566) Fix: Remove `squizlabs/php_codesniffer`
* [#1568](https://github.com/erikwang2013/stripe-php-erik/pull/1568) Enhancement: Reference `phpunit.xsd` as installed with `composer`
* [#1565](https://github.com/erikwang2013/stripe-php-erik/pull/1565) Enhancement: Use PHP 8.2 as leading PHP version

## 12.3.0 - 2023-09-14
* [#1577](https://github.com/erikwang2013/stripe-php-erik/pull/1577) Update generated code
...
* [#1573](https://github.com/erikwang2013/stripe-php-erik/pull/1573) Update generated code
  * Add support for `capture`, `create`, `expire`, `increment`, and `reverse` test helper methods on resource `Issuing.Authorization`
  * Add support for `create_force_capture`, `create_unlinked_refund`, and `refund` test helper methods on resource `Issuing.Transaction`
  * Add support for new value `stripe_tax_inactive` on enum `StripeError.code`

## 12.2.0 - 2023-09-07
* [#1571](https://github.com/erikwang2013/stripe-php-erik/pull/1571) Update generated code
...
## 12.1.0 - 2023-08-31
* [#1560](https://github.com/erikwang2013/stripe-php-erik/pull/1560) Update generated code
...
* [#1562](https://github.com/erikwang2013/stripe-php-erik/pull/1562) Nicer ApiErrorException::__toString()
* [#1558](https://github.com/erikwang2013/stripe-php-erik/pull/1558) Update generated code
...
1. **(Recommended) Upgrade your integration to be compatible with API Version `2023-08-16`.**
   ...
   You can read the [v12 migration guide](https://github.com/erikwang2013/stripe-php-erik/wiki/Migration-guide-for-v12) for more detailed instructions.
2. **(Alternative option) Specify a version other than `2023-08-16` when initializing `stripe-php`.**
     ...
     Read the [v12 migration guide](https://github.com/erikwang2013/stripe-php-erik/wiki/Migration-guide-for-v12) for more details.
...
* [#1553](https://github.com/erikwang2013/stripe-php-erik/pull/1553)⚠️ Remove deprecated enum value `Invoice.STATUS_DELETE`

* [#1550](https://github.com/erikwang2013/stripe-php-erik/pull/1550) PHPDoc changes
...
## 11.0.0 - 2023-08-16
Please do not use stripe-php v11. It did not correctly apply the [pinning behavior](https://github.com/erikwang2013/stripe-php-erik/blob/master/CHANGELOG.md#version-pinning) and was removed from packagist

## 10.21.0 - 2023-08-10
* [#1546](https://github.com/erikwang2013/stripe-php-erik/pull/1546) Update generated code
...
## 10.20.0 - 2023-08-03
* [#1539](https://github.com/erikwang2013/stripe-php-erik/pull/1539) Update generated code
...
## 10.19.0 - 2023-07-27
* [#1534](https://github.com/erikwang2013/stripe-php-erik/pull/1534) Update generated code
  * Improve PHPDoc type for `ApplicationFee.refunds`
  * Add support for `deleted` on `Apps.Secret`
* [#1526](https://github.com/erikwang2013/stripe-php-erik/pull/1526) Add constants for payment intent cancellation reasons
* [#1533](https://github.com/erikwang2013/stripe-php-erik/pull/1533) Update generated code
  * Add support for new value `service_tax` on enum `TaxRate.tax_type`
* [#1487](https://github.com/erikwang2013/stripe-php-erik/pull/1487) PHPDoc: use union of literals for $method parameter throughout
...
## 10.17.0 - 2023-07-13
* [#1525](https://github.com/erikwang2013/stripe-php-erik/pull/1525) Update generated code
...
* [#1520](https://github.com/erikwang2013/stripe-php-erik/pull/1520) Update generated code
  * Release specs are identical.

## 10.16.0 - 2023-06-29
* [#1517](https://github.com/erikwang2013/stripe-php-erik/pull/1517) Update generated code
...
* [#1514](https://github.com/erikwang2013/stripe-php-erik/pull/1514) Update generated code
  * Release specs are identical.
* [#1512](https://github.com/erikwang2013/stripe-php-erik/pull/1512) Update generated code
  * Change type of `Checkout.Session.success_url` from `string` to `nullable(string)`

## 10.15.0 - 2023-06-08
* [#1506](https://github.com/erikwang2013/stripe-php-erik/pull/1506) Update generated code
  * Add support for `preferred_locales` on `Issuing.Cardholder`

## 10.14.0 - 2023-05-25
* [#1503](https://github.com/erikwang2013/stripe-php-erik/pull/1503) Update generated code
  * Add support for `zip` on `PaymentMethod`
  * Add support for new value `zip` on enum `PaymentMethod.type`
* [#1502](https://github.com/erikwang2013/stripe-php-erik/pull/1502) Generate error codes
* [#1501](https://github.com/erikwang2013/stripe-php-erik/pull/1501) Update generated code

* [#1499](https://github.com/erikwang2013/stripe-php-erik/pull/1499) Update generated code
  * Add support for new values `amusement_tax` and `communications_tax` on enum `TaxRate.tax_type`

## 10.13.0 - 2023-05-11
* [#1490](https://github.com/erikwang2013/stripe-php-erik/pull/1490) Update generated code
  * Add support for `paypal` on `PaymentMethod`
  * Add support for `effective_percentage` on `TaxRate`
* [#1488](https://github.com/erikwang2013/stripe-php-erik/pull/1488) Increment PHPStan to strictness level 2
* [#1483](https://github.com/erikwang2013/stripe-php-erik/pull/1483) Update generated code

* [#1480](https://github.com/erikwang2013/stripe-php-erik/pull/1480) Update generated code
...
* [#1478](https://github.com/erikwang2013/stripe-php-erik/pull/1478) Update generated code
  * Release specs are identical.
* [#1475](https://github.com/erikwang2013/stripe-php-erik/pull/1475) Update generated code


## 10.12.1 - 2023-04-04
* [#1473](https://github.com/erikwang2013/stripe-php-erik/pull/1473) Update generated code
  * Add back `deleted` from `Invoice.status`.

## 10.12.0 - 2023-03-30
* [#1470](https://github.com/erikwang2013/stripe-php-erik/pull/1470) Update generated code
...
* [#1468](https://github.com/erikwang2013/stripe-php-erik/pull/1468) Trigger workflow for tags
* [#1467](https://github.com/erikwang2013/stripe-php-erik/pull/1467) Update generated code (new)
  * Release specs are identical.

## 10.11.0 - 2023-03-23
* [#1458](https://github.com/erikwang2013/stripe-php-erik/pull/1458) Update generated code
...
## 10.10.0 - 2023-03-16
* [#1457](https://github.com/erikwang2013/stripe-php-erik/pull/1457) API Updates
...
* [#1454](https://github.com/erikwang2013/stripe-php-erik/pull/1454) Update generated code (new)
  * Add support for new value `cashapp` on enum `PaymentLink.payment_method_types[]`
  * Add support for `cashapp` on `PaymentMethod`
  * Add support for new value `cashapp` on enum `PaymentMethod.type`

## 10.9.1 - 2023-03-14
* [#1453](https://github.com/erikwang2013/stripe-php-erik/pull/1453) Restore StripeClient.getService

## 10.9.0 - 2023-03-09
* [#1450](https://github.com/erikwang2013/stripe-php-erik/pull/1450) API Updates
  * Add support for `cancellation_details` on `Subscription`
  * Fix return types on custom methods (extends https://github.com/erikwang2013/stripe-php-erik/pull/1446)

* [#1446](https://github.com/erikwang2013/stripe-php-erik/pull/1446) stripe->customers->retrievePaymentMethod returns the wrong class (type hint)

## 10.8.0 - 2023-03-02
* [#1447](https://github.com/erikwang2013/stripe-php-erik/pull/1447) API Updates
  * Add support for `reconciliation_status` on `Payout`
  * Add support for new value `lease_tax` on enum `TaxRate.tax_type`

## 10.7.0 - 2023-02-23
* [#1444](https://github.com/erikwang2013/stripe-php-erik/pull/1444) API Updates
  * Add support for new value `igst` on enum `TaxRate.tax_type`

## 10.6.1 - 2023-02-21
* [#1443](https://github.com/erikwang2013/stripe-php-erik/pull/1443) Remove init.php from the list of ignored files

## 10.6.0 - 2023-02-16
* [#1441](https://github.com/erikwang2013/stripe-php-erik/pull/1441) API Updates
  * Add support for `refund_payment` method on resource `Terminal.Reader`
  * Add support for `custom_fields` on `Checkout.Session` and `PaymentLink`
* [#1236](https://github.com/erikwang2013/stripe-php-erik/pull/1236) subscription_proration_date not always presented in Invoice
* [#1431](https://github.com/erikwang2013/stripe-php-erik/pull/1431) Fix: Do not use unbounded version constraint for `actions/checkout`
* [#1436](https://github.com/erikwang2013/stripe-php-erik/pull/1436) Enhancement: Enable and configure `visibility_required` fixer
* [#1432](https://github.com/erikwang2013/stripe-php-erik/pull/1432) Enhancement: Update `actions/cache`
* [#1434](https://github.com/erikwang2013/stripe-php-erik/pull/1434) Fix: Remove parentheses
* [#1433](https://github.com/erikwang2013/stripe-php-erik/pull/1433) Enhancement: Run tests on PHP 8.2
* [#1438](https://github.com/erikwang2013/stripe-php-erik/pull/1438) Update .gitattributes

## 10.5.0 - 2023-02-02
* [#1439](https://github.com/erikwang2013/stripe-php-erik/pull/1439) API Updates
...
## 10.4.0 - 2023-01-19
* [#1381](https://github.com/erikwang2013/stripe-php-erik/pull/1381) Add getService methods to StripeClient and AbstractServiceFactory to allow mocking
* [#1424](https://github.com/erikwang2013/stripe-php-erik/pull/1424) API Updates

  * Added `REFUND_CREATED`, `REFUND_UPDATED` event definitions.
* [#1426](https://github.com/erikwang2013/stripe-php-erik/pull/1426) Ignore PHP version for formatting
* [#1425](https://github.com/erikwang2013/stripe-php-erik/pull/1425) Fix Stripe::setAccountId parameter type
* [#1418](https://github.com/erikwang2013/stripe-php-erik/pull/1418) Switch to mb_convert_encoding to fix utf8_encode deprecation warning

## 10.3.0 - 2022-12-22
* [#1413](https://github.com/erikwang2013/stripe-php-erik/pull/1413) API Updates
  Change `CheckoutSession.cancel_url` to be nullable.

## 10.2.0 - 2022-12-15
* [#1411](https://github.com/erikwang2013/stripe-php-erik/pull/1411) API Updates
  * Add support for new value `invoice_overpaid` on enum `CustomerBalanceTransaction.type`
* [#1407](https://github.com/erikwang2013/stripe-php-erik/pull/1407) API Updates


## 10.1.0 - 2022-12-06
* [#1405](https://github.com/erikwang2013/stripe-php-erik/pull/1405) API Updates
  * Add support for `flow` on `BillingPortal.Session`
* [#1404](https://github.com/erikwang2013/stripe-php-erik/pull/1404) API Updates
...
## 10.0.0 - 2022-11-16
* [#1392](https://github.com/erikwang2013/stripe-php-erik/pull/1392) Next major release changes
...
### Deprecated
* [#1382](https://github.com/erikwang2013/stripe-php-erik/pull/1382) Mark `resource.save` as deprecated. Prefer the static update method that doesn't require retrieval of the resource to update it.
```PHP
// before
...
### ⚠️ Removed
- [#1377](https://github.com/erikwang2013/stripe-php-erik/pull/1377) Removed deprecated `Sku` resource and service
- [#1375](https://github.com/erikwang2013/stripe-php-erik/pull/1375) Removed deprecated `Orders` resource and service
- [#1375](https://github.com/erikwang2013/stripe-php-erik/pull/1375) Removed deprecated `Product` field from the `LineItem`
- [#1388](https://github.com/erikwang2013/stripe-php-erik/pull/1388) Removed deprecated `AlipayAccount` resource
- [#1396](https://github.com/erikwang2013/stripe-php-erik/pull/1396) Removed `charges` field on `PaymentIntent` and replace it with `latest_charge`.


## 9.9.0 - 2022-11-08
* [#1394](https://github.com/erikwang2013/stripe-php-erik/pull/1394) API Updates
  * Add support for new values `eg_tin`, `ph_tin`, and `tr_tin` on enum `TaxId.type`
* [#1389](https://github.com/erikwang2013/stripe-php-erik/pull/1389) API Updates
  * Add support for `on_behalf_of` on `Subscription`
* [#1379](https://github.com/erikwang2013/stripe-php-erik/pull/1379) Do not run Coveralls in PR-s

## 9.8.0 - 2022-10-20
* [#1383](https://github.com/erikwang2013/stripe-php-erik/pull/1383) API Updates
  * Add support for new values `jp_trn` and `ke_pin` on enum `TaxId.type`
* [#1293](https://github.com/erikwang2013/stripe-php-erik/pull/1293) Install deps in the install step of CI
* [#1291](https://github.com/erikwang2013/stripe-php-erik/pull/1291) Fix: Configure finder for `friendsofphp/php-cs-fixer`

## 9.7.0 - 2022-10-13
* [#1376](https://github.com/erikwang2013/stripe-php-erik/pull/1376) API Updates
  * Add support for `network_data` on `Issuing.Authorization`
* [#1374](https://github.com/erikwang2013/stripe-php-erik/pull/1374) Add request_log_url on ErrorObject
* [#1370](https://github.com/erikwang2013/stripe-php-erik/pull/1370) API Updates
  * Add support for `created` on `Checkout.Session`

## 9.6.0 - 2022-09-15
* [#1365](https://github.com/erikwang2013/stripe-php-erik/pull/1365) API Updates
...
## 9.5.0 - 2022-09-06
* [#1364](https://github.com/erikwang2013/stripe-php-erik/pull/1364) API Updates
  * Add support for new value `terminal_reader_splashscreen` on enum `File.purpose`
* [#1363](https://github.com/erikwang2013/stripe-php-erik/pull/1363) chore: Update PHP tests to handle search methods.

## 9.4.0 - 2022-08-26
* [#1362](https://github.com/erikwang2013/stripe-php-erik/pull/1362) API Updates
  * Add support for `login_page` on `BillingPortal.Configuration`
* [#1360](https://github.com/erikwang2013/stripe-php-erik/pull/1360) Add test coverage using Coveralls
* [#1361](https://github.com/erikwang2013/stripe-php-erik/pull/1361) fix: Fix type hints for error objects.
  * Update `Invoice.last_finalization_error`, `PaymentIntent.last_payment_error`, `SetupAttempt.setup_error` and `SetupIntent.setup_error` type to be `StripeObject`.
    * Addresses https://github.com/erikwang2013/stripe-php-erik/issues/1353. The library today does not actually return a `ErrorObject` for these fields, so the type annotation was incorrect.
* [#1356](https://github.com/erikwang2013/stripe-php-erik/pull/1356) Add beta readme.md section

## 9.3.0 - 2022-08-23
* [#1355](https://github.com/erikwang2013/stripe-php-erik/pull/1355) API Updates
...
## 9.2.0 - 2022-08-19
* [#1352](https://github.com/erikwang2013/stripe-php-erik/pull/1352) API Updates
  * Add support for new resource `CustomerCashBalanceTransaction`
  * Add support for `currency` on `PaymentLink`
  * Add constant for `customer_cash_balance_transaction.created` webhook event.
* [#1351](https://github.com/erikwang2013/stripe-php-erik/pull/1351) Add a support section to the readme
* [#1304](https://github.com/erikwang2013/stripe-php-erik/pull/1304) Allow passing PSR-3 loggers to setLogger as they are compatible

## 9.1.0 - 2022-08-11
* [#1348](https://github.com/erikwang2013/stripe-php-erik/pull/1348) API Updates
  * Add support for `payment_method_collection` on `Checkout.Session` and `PaymentLink`

* [#1346](https://github.com/erikwang2013/stripe-php-erik/pull/1346) API Updates
  * Add support for `expires_at` on `Apps.Secret`

## 9.0.0 - 2022-08-02

Breaking changes that arose during code generation of the library that we postponed for the next major version. For changes to the SDK, read more detailed description at https://github.com/erikwang2013/stripe-php-erik/wiki/Migration-guide-for-v9. For changes to the Stripe products, read more at https://docs.stripe.com/changelog/2022-08-01.

"⚠️" symbol highlights breaking changes.

* [#1344](https://github.com/erikwang2013/stripe-php-erik/pull/1344) API Updates
* [#1337](https://github.com/erikwang2013/stripe-php-erik/pull/1337) API Updates
* [#1273](https://github.com/erikwang2013/stripe-php-erik/pull/1273) Add some PHPDoc return types and fixes
* [#1341](https://github.com/erikwang2013/stripe-php-erik/pull/1341) Next major release changes
...
### ⚠️ Changed
* Updated certificate bundle ([#1314](https://github.com/erikwang2013/stripe-php-erik/pull/1314))
...
## 8.12.0 - 2022-07-25
* [#1332](https://github.com/erikwang2013/stripe-php-erik/pull/1332) API Updates
  * Add support for `default_currency` and `invoice_credit_balance` on `Customer`


## 8.11.0 - 2022-07-18
* [#1324](https://github.com/erikwang2013/stripe-php-erik/pull/1324) API Updates
...
* [#1322](https://github.com/erikwang2013/stripe-php-erik/pull/1322) API Updates
  * Change type of `source_type` on `Transfer` from nullable string to string (comment-only change)

## 8.10.0 - 2022-07-07
* [#1319](https://github.com/erikwang2013/stripe-php-erik/pull/1319) API Updates
  * Add support for `currency_options` on `Coupon` and `Price`
  * Add support for `currency` on `Subscription`
* [#1318](https://github.com/erikwang2013/stripe-php-erik/pull/1318) API Updates
...
## 8.9.0 - 2022-06-29
* [#1316](https://github.com/erikwang2013/stripe-php-erik/pull/1316) API Updates
...
## 8.8.0 - 2022-06-23
* [#1302](https://github.com/erikwang2013/stripe-php-erik/pull/1302) API Updates
  * Add support for `custom_unit_amount` on `Price`
* [#1301](https://github.com/erikwang2013/stripe-php-erik/pull/1301) API Updates

  Documentation updates.

## 8.7.0 - 2022-06-17
* [#1306](https://github.com/erikwang2013/stripe-php-erik/pull/1306) API Updates
  * Add support for `fund_cash_balance` test helper method on resource `Customer`
  * Add support for `total_excluding_tax` on `CreditNote`
  * Add support for `rendering_options` on `Invoice`
* [#1307](https://github.com/erikwang2013/stripe-php-erik/pull/1307) Support updating pre-release versions
* [#1305](https://github.com/erikwang2013/stripe-php-erik/pull/1305) Trigger workflows on beta branches
* [#1302](https://github.com/erikwang2013/stripe-php-erik/pull/1302) API Updates
  * Add support for `custom_unit_amount` on `Price`
* [#1301](https://github.com/erikwang2013/stripe-php-erik/pull/1301) API Updates
...
## 8.6.0 - 2022-06-08
* [#1300](https://github.com/erikwang2013/stripe-php-erik/pull/1300) API Updates
  * Add support for `attach_to_self` and `flow_directions` on `SetupAttempt`

## 8.5.0 - 2022-06-01
* [#1298](https://github.com/erikwang2013/stripe-php-erik/pull/1298) API Updates
...
## 8.4.0 - 2022-05-26
* [#1296](https://github.com/erikwang2013/stripe-php-erik/pull/1296) API Updates
...
* [#1295](https://github.com/erikwang2013/stripe-php-erik/pull/1295) API Updates


## 8.3.0 - 2022-05-23
* [#1294](https://github.com/erikwang2013/stripe-php-erik/pull/1294) API Updates
...
* [#1289](https://github.com/erikwang2013/stripe-php-erik/pull/1289) fix: Update RequestOptions#redactedApiKey to stop exploding null.

## 8.2.0 - 2022-05-19
* [#1286](https://github.com/erikwang2013/stripe-php-erik/pull/1286) API Updates
...
## 8.1.0 - 2022-05-11
* [#1284](https://github.com/erikwang2013/stripe-php-erik/pull/1284) API Updates
...
## 8.0.0 - 2022-05-09
* [#1283](https://github.com/erikwang2013/stripe-php-erik/pull/1283) Major version release of v8.0.0. The [migration guide](https://github.com/erikwang2013/stripe-php-erik/wiki/Migration-Guide-for-v8) contains more information.
  (⚠️ = breaking changes):
...
## 7.128.0 - 2022-05-05
* [#1282](https://github.com/erikwang2013/stripe-php-erik/pull/1282) API Updates
  * Add support for `default_price` on `Product`
  * Add support for `instructions_email` on `Refund`


## 7.127.0 - 2022-05-05
* [#1281](https://github.com/erikwang2013/stripe-php-erik/pull/1281) API Updates
  * Add support for new resources `FinancialConnections.AccountOwner`, `FinancialConnections.AccountOwnership`, `FinancialConnections.Account`, and `FinancialConnections.Session`
* [#1278](https://github.com/erikwang2013/stripe-php-erik/pull/1278) Pin setup-php action version.
* [#1277](https://github.com/erikwang2013/stripe-php-erik/pull/1277) API Updates
  * Add support for `registered_address` on `Person`

## 7.126.0 - 2022-05-03
* [#1276](https://github.com/erikwang2013/stripe-php-erik/pull/1276) API Updates
  * Add support for new resource `CashBalance`
  * Change type of `BillingPortal.Configuration.application` from `$Application` to `deletable($Application)`
  * Add support for `cash_balance` on `Customer`
  * Add support for `application` on `Invoice`, `Quote`, `SubscriptionSchedule`, and `Subscription`
  * Add support for new value `eu_oss_vat` on enum `TaxId.type`
* [#1274](https://github.com/erikwang2013/stripe-php-erik/pull/1274) Fix PHPDoc on Discount for nullable properties
* [#1272](https://github.com/erikwang2013/stripe-php-erik/pull/1272) Allow users to pass a custom IPRESOLVE cURL option.

## 7.125.0 - 2022-04-21
* [#1270](https://github.com/erikwang2013/stripe-php-erik/pull/1270) API Updates
  * Add support for `expire` test helper method on resource `Refund`

## 7.124.0 - 2022-04-18
* [#1265](https://github.com/erikwang2013/stripe-php-erik/pull/1265) API Updates
...
## 7.123.0 - 2022-04-13
* [#1263](https://github.com/erikwang2013/stripe-php-erik/pull/1263) API Updates
  * Add support for `increment_authorization` method on resource `PaymentIntent`
* [#1262](https://github.com/erikwang2013/stripe-php-erik/pull/1262) Add support for updating the version of the repo
* [#1230](https://github.com/erikwang2013/stripe-php-erik/pull/1230) Add PHPDoc return types
* [#1242](https://github.com/erikwang2013/stripe-php-erik/pull/1242) Fix some PHPDoc in tests

## 7.122.0 - 2022-04-08
* [#1261](https://github.com/erikwang2013/stripe-php-erik/pull/1261) API Updates
  * Add support for `apply_customer_balance` method on resource `PaymentIntent`
* [#1259](https://github.com/erikwang2013/stripe-php-erik/pull/1259) API Updates

  * Add `payment_intent.partially_funded`, `terminal.reader.action_failed`, and `terminal.reader.action_succeeded` events.

## 7.121.0 - 2022-03-30
* [#1258](https://github.com/erikwang2013/stripe-php-erik/pull/1258) API Updates
  * Add support for `cancel_action`, `process_payment_intent`, `process_setup_intent`, and `set_reader_display` methods on resource `Terminal.Reader`
  * Add support for `action` on `Terminal.Reader`

## 7.120.0 - 2022-03-29
* [#1257](https://github.com/erikwang2013/stripe-php-erik/pull/1257) API Updates
  * Add support for Search API
    * Add support for `search` method on resources `Charge`, `Customer`, `Invoice`, `PaymentIntent`, `Price`, `Product`, and `Subscription`

## 7.119.0 - 2022-03-25
* [#1256](https://github.com/erikwang2013/stripe-php-erik/pull/1256) API Updates
...
## 7.118.0 - 2022-03-23
* [#1255](https://github.com/erikwang2013/stripe-php-erik/pull/1255) API Updates
...
## 7.117.0 - 2022-03-18
* [#1254](https://github.com/erikwang2013/stripe-php-erik/pull/1254) API Updates
  * Add support for `status` on `Card`
* [#1251](https://github.com/erikwang2013/stripe-php-erik/pull/1251) Add support for SearchResult objects.
* [#1249](https://github.com/erikwang2013/stripe-php-erik/pull/1249) Add missing constant for payment_behavior

## 7.116.0 - 2022-03-02
* [#1248](https://github.com/erikwang2013/stripe-php-erik/pull/1248) API Updates
  * Add support for `proration_details` on `InvoiceLineItem`


## 7.115.0 - 2022-03-01
* [#1245](https://github.com/erikwang2013/stripe-php-erik/pull/1245) [#1247](https://github.com/erikwang2013/stripe-php-erik/pull/1247) API Updates
...
* [#1244](https://github.com/erikwang2013/stripe-php-erik/pull/1244) API Updates
  * Add support for new values `bbpos_wisepad3` and `stripe_m2` on enum `Terminal.Reader.device_type`

## 7.114.0 - 2022-02-15
* [#1243](https://github.com/erikwang2013/stripe-php-erik/pull/1243) Add test
* [#1240](https://github.com/erikwang2013/stripe-php-erik/pull/1240) API Updates
  * Add support for `verify_microdeposits` method on resources `PaymentIntent` and `SetupIntent`
* [#1241](https://github.com/erikwang2013/stripe-php-erik/pull/1241) Add generic parameter to \Stripe\Collection usages

## 7.113.0 - 2022-02-03
* [#1239](https://github.com/erikwang2013/stripe-php-erik/pull/1239) API Updates
  * Add `REASON_EXPIRED_UNCAPTURED_CHARGE` enum value on `Refund`.

## 7.112.0 - 2022-01-25
* [#1235](https://github.com/erikwang2013/stripe-php-erik/pull/1235) API Updates
  * Add support for `phone_number_collection` on `PaymentLink`
  * Add support for new value `is_vat` on enum `TaxId.type`


## 7.111.0 - 2022-01-20
* [#1233](https://github.com/erikwang2013/stripe-php-erik/pull/1233) API Updates
  * Add support for new resource `PaymentLink`
  * Add support for `payment_link` on `Checkout.Session`

## 7.110.0 - 2022-01-13
* [#1232](https://github.com/erikwang2013/stripe-php-erik/pull/1232) API Updates
  * Add support for `paid_out_of_band` on `Invoice`

## 7.109.0 - 2022-01-12
* [#1231](https://github.com/erikwang2013/stripe-php-erik/pull/1231) API Updates
  * Add support for `customer_creation` on `Checkout.Session`
* [#1227](https://github.com/erikwang2013/stripe-php-erik/pull/1227) Update docs URLs

## 7.108.0 - 2021-12-22
* [#1226](https://github.com/erikwang2013/stripe-php-erik/pull/1226) Upgrade php-cs-fixer to 3.4.0.
* [#1222](https://github.com/erikwang2013/stripe-php-erik/pull/1222) API Updates
  * Add support for `processing` on `PaymentIntent`
* [#1220](https://github.com/erikwang2013/stripe-php-erik/pull/1220) API Updates

## 7.107.0 - 2021-12-09
* [#1219](https://github.com/erikwang2013/stripe-php-erik/pull/1219) API Updates
  * Add support for `metadata` on `BillingPortal.Configuration`
  * Add support for `wallets` on `Issuing.Card`

## 7.106.0 - 2021-12-09
* [#1218](https://github.com/erikwang2013/stripe-php-erik/pull/1218) API Updates
  * Add support for new values `ge_vat` and `ua_vat` on enum `TaxId.type`
* [#1216](https://github.com/erikwang2013/stripe-php-erik/pull/1216) Fix namespaced classes in @return PHPDoc.
* [#1214](https://github.com/erikwang2013/stripe-php-erik/pull/1214) Announce PHP8 support in CHANGELOG.md

## 7.105.0 - 2021-12-06
* [#1213](https://github.com/erikwang2013/stripe-php-erik/pull/1213) PHP 8.1 missing ReturnTypeWillChange annotations.
* As of this version, PHP 8.1 is officially supported.

## 7.104.0 - 2021-12-01
* [#1211](https://github.com/erikwang2013/stripe-php-erik/pull/1211) PHPStan compatibility with PHP8.x
* [#1209](https://github.com/erikwang2013/stripe-php-erik/pull/1209) PHPUnit compatibility with PHP 8.x

## 7.103.0 - 2021-11-19
* [#1206](https://github.com/erikwang2013/stripe-php-erik/pull/1206) API Updates
  * Add support for new value `jct` on enum `TaxRate.tax_type`

## 7.102.0 - 2021-11-17
* [#1205](https://github.com/erikwang2013/stripe-php-erik/pull/1205) API Updates
  * Add support for `automatic_payment_methods` on `PaymentIntent`

## 7.101.0 - 2021-11-16
* [#1203](https://github.com/erikwang2013/stripe-php-erik/pull/1203) API Updates
...
## 7.100.0 - 2021-10-11
* [#1190](https://github.com/erikwang2013/stripe-php-erik/pull/1190) API Updates
  * Add support for `klarna` on `PaymentMethod`.

## 7.99.0 - 2021-10-11
* [#1188](https://github.com/erikwang2013/stripe-php-erik/pull/1188) API Updates
  * Add support for `list_payment_methods` method on resource `Customer`

## 7.98.0 - 2021-10-07
* [#1187](https://github.com/erikwang2013/stripe-php-erik/pull/1187) API Updates
...
## 7.97.0 - 2021-09-16
* [#1181](https://github.com/erikwang2013/stripe-php-erik/pull/1181) API Updates
  * Add support for `full_name_aliases` on `Person`

## 7.96.0 - 2021-09-15
* [#1178](https://github.com/erikwang2013/stripe-php-erik/pull/1178) API Updates
  * Add support for livemode on Reporting.ReportType
  * Add support for new value `rst` on enum `TaxRate.tax_type`

## 7.95.0 - 2021-09-01
* [#1177](https://github.com/erikwang2013/stripe-php-erik/pull/1177) API Updates
...
## 7.94.0 - 2021-08-19
* [#1173](https://github.com/erikwang2013/stripe-php-erik/pull/1173) API Updates
  * Add support for new value `fil` on enum `Checkout.Session.locale`
  * Add support for new value `au_arn` on enum `TaxId.type`

## 7.93.0 - 2021-08-11
* [#1172](https://github.com/erikwang2013/stripe-php-erik/pull/1172) API Updates
  * Add support for `locale` on `BillingPortal.Session`

* [#1171](https://github.com/erikwang2013/stripe-php-erik/pull/1171) Fix typo in docblock `CurlClient::executeStreamingRequestWithRetries`

## 7.92.0 - 2021-07-28
* [#1167](https://github.com/erikwang2013/stripe-php-erik/pull/1167) API Updates
  * Add support for `account_type` on `BankAccount`
  * Add support for new value `redacted` on enum `Review.closed_reason`

## 7.91.0 - 2021-07-22
* [#1164](https://github.com/erikwang2013/stripe-php-erik/pull/1164) API Updates
  * Add support for new values `hr`, `ko`, and `vi` on enum `Checkout.Session.locale`
  * Add support for `payment_settings` on `Subscription`

## 7.90.0 - 2021-07-20
* [#1163](https://github.com/erikwang2013/stripe-php-erik/pull/1163) API Updates
  * Add support for `wallet` on `Issuing.Transaction`
* [#1160](https://github.com/erikwang2013/stripe-php-erik/pull/1160) Remove unused API error types from docs.

## 7.89.0 - 2021-07-14
* [#1158](https://github.com/erikwang2013/stripe-php-erik/pull/1158) API Updates
  * Add support for `list_computed_upfront_line_items` method on resource `Quote`
* [#1157](https://github.com/erikwang2013/stripe-php-erik/pull/1157) Improve readme for old PHP versions

## 7.88.0 - 2021-07-09
* [#1152](https://github.com/erikwang2013/stripe-php-erik/pull/1152) API Updates
  * Add support for new resource `Quote`
  * Add support for `quote` on `Invoice`
  * Add support for new value `quote_accept` on enum `Invoice.billing_reason`
* [#1155](https://github.com/erikwang2013/stripe-php-erik/pull/1155) Add streaming methods to Service infra
...
* [#1151](https://github.com/erikwang2013/stripe-php-erik/pull/1151) Add `mode` constants into Checkout\Session

## 7.87.0 - 2021-06-30
* [#1149](https://github.com/erikwang2013/stripe-php-erik/pull/1149) API Updates
  * Add support for `wechat_pay` on `PaymentMethod`
* [#1143](https://github.com/erikwang2013/stripe-php-erik/pull/1143) Streaming requests
* [#1138](https://github.com/erikwang2013/stripe-php-erik/pull/1138) Deprecate travis

## 7.86.0 - 2021-06-25
* [#1145](https://github.com/erikwang2013/stripe-php-erik/pull/1145) API Updates
  * Add support for `boleto` on `PaymentMethod`.
  * Add support for `il_vat` as a member of the `TaxID.Type` enum.

## 7.85.0 - 2021-06-18
* [#1142](https://github.com/erikwang2013/stripe-php-erik/pull/1142) API Updates
  * Add support for new TaxId types: `ca_pst_mb`, `ca_pst_bc`, `ca_gst_hst`, and `ca_pst_sk`.

## 7.84.0 - 2021-06-16
* [#1141](https://github.com/erikwang2013/stripe-php-erik/pull/1141) Update PHPDocs
  * Add support for `url` on `Checkout\Session`


## 7.83.0 - 2021-06-07
* [#1140](https://github.com/erikwang2013/stripe-php-erik/pull/1140) API Updates
...
## 7.82.0 - 2021-06-04
* [#1136](https://github.com/erikwang2013/stripe-php-erik/pull/1136) Update PHPDocs
  * Add support for `controller` on `Account`.

## 7.81.0 - 2021-06-04
* [#1135](https://github.com/erikwang2013/stripe-php-erik/pull/1135) API Updates
...
## 7.80.0 - 2021-05-26
* [#1130](https://github.com/erikwang2013/stripe-php-erik/pull/1130) Update PHPDocs

## 7.79.0 - 2021-05-19
* [#1126](https://github.com/erikwang2013/stripe-php-erik/pull/1126) API Updates
...
## 7.78.0 - 2021-05-05
* [#1120](https://github.com/erikwang2013/stripe-php-erik/pull/1120) Update PHPDocs
  * Add support for `Radar.EarlyFraudWarning.payment_intent`

## 7.77.0 - 2021-04-12
* [#1110](https://github.com/erikwang2013/stripe-php-erik/pull/1110) Update PHPDocs
  * Add support for `acss_debit` on `PaymentMethod`
  * Add support for `payment_method_options` on `Checkout\Session`
* [#1107](https://github.com/erikwang2013/stripe-php-erik/pull/1107) Remove duplicate object phpdoc

## 7.76.0 - 2021-03-22
* [#1100](https://github.com/erikwang2013/stripe-php-erik/pull/1100) Update PHPDocs
  * Added support for `amount_shipping` on `Checkout.Session.total_details`
* [#1088](https://github.com/erikwang2013/stripe-php-erik/pull/1088) Make possibility to extend CurlClient

## 7.75.0 - 2021-02-22
* [#1094](https://github.com/erikwang2013/stripe-php-erik/pull/1094) Add support for Billing Portal Configuration API

## 7.74.0 - 2021-02-17
* [#1093](https://github.com/erikwang2013/stripe-php-erik/pull/1093) Update PHPDocs
  * Add support for on_behalf_of to Invoice

## 7.73.0 - 2021-02-16
* [#1091](https://github.com/erikwang2013/stripe-php-erik/pull/1091) Update PHPDocs
  * Add support for `afterpay_clearpay` on `PaymentMethod`.

## 7.72.0 - 2021-02-08
* [#1089](https://github.com/erikwang2013/stripe-php-erik/pull/1089) Update PHPDocs
  * Add support for `afterpay_clearpay_payments` on `Account.capabilities`
  * Add support for `payment_settings` on `Invoice`

## 7.71.0 - 2021-02-05
* [#1087](https://github.com/erikwang2013/stripe-php-erik/pull/1087) Update PHPDocs
* [#1086](https://github.com/erikwang2013/stripe-php-erik/pull/1086) Update CA cert bundle URL

## 7.70.0 - 2021-02-03
* [#1085](https://github.com/erikwang2013/stripe-php-erik/pull/1085) Update PHPDocs
  * Add support for `nationality` on `Person`
  * Add member `gb_vat` of `TaxID` enum


## 7.69.0 - 2021-01-21
* [#1079](https://github.com/erikwang2013/stripe-php-erik/pull/1079) Update PHPDocs

## 7.68.0 - 2021-01-14
* [#1063](https://github.com/erikwang2013/stripe-php-erik/pull/1063) Multiple API changes
* [#1061](https://github.com/erikwang2013/stripe-php-erik/pull/1061) Bump phpDocumentor to 3.0.0

## 7.67.0 - 2020-12-09
* [#1060](https://github.com/erikwang2013/stripe-php-erik/pull/1060) Improve PHPDocs for `Discount`
* [#1059](https://github.com/erikwang2013/stripe-php-erik/pull/1059) Upgrade PHPStan to 0.12.59
* [#1057](https://github.com/erikwang2013/stripe-php-erik/pull/1057) Bump PHP-CS-Fixer and update code

## 7.66.1 - 2020-12-01
* [#1054](https://github.com/erikwang2013/stripe-php-erik/pull/1054) Improve error message for invalid keys in StripeClient

## 7.66.0 - 2020-11-24
* [#1053](https://github.com/erikwang2013/stripe-php-erik/pull/1053) Update PHPDocs

## 7.65.0 - 2020-11-19
* [#1050](https://github.com/erikwang2013/stripe-php-erik/pull/1050) Added constants for `proration_behavior` on `Subscription`

## 7.64.0 - 2020-11-18
* [#1049](https://github.com/erikwang2013/stripe-php-erik/pull/1049) Update PHPDocs

## 7.63.0 - 2020-11-17
* [#1048](https://github.com/erikwang2013/stripe-php-erik/pull/1048) Update PHPDocs
* [#1046](https://github.com/erikwang2013/stripe-php-erik/pull/1046) Force IPv4 resolving

## 7.62.0 - 2020-11-09
* [#1041](https://github.com/erikwang2013/stripe-php-erik/pull/1041) Add missing constants on `Event`
* [#1038](https://github.com/erikwang2013/stripe-php-erik/pull/1038) Update PHPDocs

## 7.61.0 - 2020-10-20
* [#1030](https://github.com/erikwang2013/stripe-php-erik/pull/1030) Add support for `jp_rn` and `ru_kpp` as a `type` on `TaxId`

## 7.60.0 - 2020-10-15
* [#1027](https://github.com/erikwang2013/stripe-php-erik/pull/1027) Warn if opts are in params

## 7.58.0 - 2020-10-14
* [#1026](https://github.com/erikwang2013/stripe-php-erik/pull/1026) Add support for the Payout Reverse API

## 7.57.0 - 2020-09-29
* [#1020](https://github.com/erikwang2013/stripe-php-erik/pull/1020) Add support for the `SetupAttempt` resource and List API

## 7.56.0 - 2020-09-25
* [#1019](https://github.com/erikwang2013/stripe-php-erik/pull/1019) Update PHPDocs

## 7.55.0 - 2020-09-24
* [#1018](https://github.com/erikwang2013/stripe-php-erik/pull/1018) Multiple API changes
  * Updated PHPDocs
  * Added `TYPE_CONTRIBUTION` as a constant on `BalanceTransaction`

## 7.54.0 - 2020-09-23
* [#1017](https://github.com/erikwang2013/stripe-php-erik/pull/1017) Updated PHPDoc

## 7.53.1 - 2020-09-22
* [#1015](https://github.com/erikwang2013/stripe-php-erik/pull/1015) Bugfix: don't error on systems with php_uname in disablefunctions with whitespace

## 7.53.0 - 2020-09-21
* [#1016](https://github.com/erikwang2013/stripe-php-erik/pull/1016) Updated PHPDocs

## 7.52.0 - 2020-09-08
* [#1010](https://github.com/erikwang2013/stripe-php-erik/pull/1010) Update PHPDocs

## 7.51.0 - 2020-09-02
* [#1007](https://github.com/erikwang2013/stripe-php-erik/pull/1007) Multiple API changes
  * Add support for the Issuing Dispute Submit API
  * Add constants for `payment_status` on Checkout `Session`
* [#1003](https://github.com/erikwang2013/stripe-php-erik/pull/1003) Add trim to getSignatures to allow for leading whitespace.

## 7.50.0 - 2020-08-28
* [#1005](https://github.com/erikwang2013/stripe-php-erik/pull/1005) Updated PHPDocs

## 7.49.0 - 2020-08-19
* [#998](https://github.com/erikwang2013/stripe-php-erik/pull/998) PHPDocs updated

## 7.48.0 - 2020-08-17
* [#997](https://github.com/erikwang2013/stripe-php-erik/pull/997) PHPDocs updated
* [#996](https://github.com/erikwang2013/stripe-php-erik/pull/996) Fixing telemetry

## 7.47.0 - 2020-08-13
* [#994](https://github.com/erikwang2013/stripe-php-erik/pull/994) Nullable balance_transactions on issuing disputes
* [#991](https://github.com/erikwang2013/stripe-php-erik/pull/991) Fix invalid return types in OAuthService

## 7.46.1 - 2020-08-07
* [#990](https://github.com/erikwang2013/stripe-php-erik/pull/990) PHPdoc changes

## 7.46.0 - 2020-08-05
* [#989](https://github.com/erikwang2013/stripe-php-erik/pull/989) Add support for the `PromotionCode` resource and APIs

## 7.45.0 - 2020-07-28
* [#981](https://github.com/erikwang2013/stripe-php-erik/pull/981) PHPdoc updates

## 7.44.0 - 2020-07-20
* [#948](https://github.com/erikwang2013/stripe-php-erik/pull/948) Add `first()` and `last()` functions to `Collection`

## 7.43.0 - 2020-07-17
* [#975](https://github.com/erikwang2013/stripe-php-erik/pull/975) Add support for `political_exposure` on `Person`

## 7.42.0 - 2020-07-15
* [#974](https://github.com/erikwang2013/stripe-php-erik/pull/974) Add new constants for `purpose` on `File`

## 7.41.1 - 2020-07-15
* [#973](https://github.com/erikwang2013/stripe-php-erik/pull/973) Multiple PHPDoc fixes

## 7.41.0 - 2020-07-14
* [#971](https://github.com/erikwang2013/stripe-php-erik/pull/971) Adds enum values for `billing_address_collection` on Checkout `Session`

## 7.40.0 - 2020-07-06
* [#964](https://github.com/erikwang2013/stripe-php-erik/pull/964) Add OAuthService

## 7.39.0 - 2020-06-25
* [#960](https://github.com/erikwang2013/stripe-php-erik/pull/960) Add constants for `payment_behavior` on `Subscription`

## 7.38.0 - 2020-06-24
* [#959](https://github.com/erikwang2013/stripe-php-erik/pull/959) Add multiple constants missing for `Event`

## 7.37.2 - 2020-06-23
* [#957](https://github.com/erikwang2013/stripe-php-erik/pull/957) Updated PHPDocs

## 7.37.1 - 2020-06-11
* [#952](https://github.com/erikwang2013/stripe-php-erik/pull/952) Improve PHPDoc

## 7.37.0 - 2020-06-09
* [#950](https://github.com/erikwang2013/stripe-php-erik/pull/950) Add support for `id_npwp` and `my_frp` as `type` on `TaxId`

## 7.36.2 - 2020-06-03
* [#946](https://github.com/erikwang2013/stripe-php-erik/pull/946) Update PHPDoc

## 7.36.1 - 2020-05-28
* [#938](https://github.com/erikwang2013/stripe-php-erik/pull/938) Remove extra array_keys() call.
* [#942](https://github.com/erikwang2013/stripe-php-erik/pull/942) fix autopagination for service methods

## 7.36.0 - 2020-05-21
* [#937](https://github.com/erikwang2013/stripe-php-erik/pull/937) Add support for `ae_trn`, `cl_tin` and `sa_vat` as `type` on `TaxId`

## 7.35.0 - 2020-05-20
* [#936](https://github.com/erikwang2013/stripe-php-erik/pull/936) Add `anticipation_repayment` as a `type` on `BalanceTransaction`

## 7.34.0 - 2020-05-18
* [#934](https://github.com/erikwang2013/stripe-php-erik/pull/934) Add support for `issuing_dispute` as a `type` on `BalanceTransaction`

## 7.33.1 - 2020-05-15
* [#933](https://github.com/erikwang2013/stripe-php-erik/pull/933) Services bugfix: convert nested null params to empty strings

## 7.33.0 - 2020-05-14
* [#771](https://github.com/erikwang2013/stripe-php-erik/pull/771) Introduce client/services API. The [migration guide](https://github.com/erikwang2013/stripe-php-erik/wiki/Migration-to-StripeClient-and-services-in-7.33.0) contains before & after examples of the backwards-compatible changes.

## 7.32.1 - 2020-05-13
* [#932](https://github.com/erikwang2013/stripe-php-erik/pull/932) Fix multiple PHPDoc

## 7.32.0 - 2020-05-11
* [#931](https://github.com/erikwang2013/stripe-php-erik/pull/931) Add support for the `LineItem` resource and APIs

## 7.31.0 - 2020-05-01
* [#927](https://github.com/erikwang2013/stripe-php-erik/pull/927) Add support for new tax IDs

## 7.30.0 - 2020-04-29
* [#924](https://github.com/erikwang2013/stripe-php-erik/pull/924) Add support for the `Price` resource and APIs

## 7.29.0 - 2020-04-22
* [#920](https://github.com/erikwang2013/stripe-php-erik/pull/920) Add support for the `Session` resource and APIs on the `BillingPortal` namespace

## 7.28.1 - 2020-04-10
* [#915](https://github.com/erikwang2013/stripe-php-erik/pull/915) Improve PHPdocs for many classes

## 7.28.0 - 2020-04-03
* [#912](https://github.com/erikwang2013/stripe-php-erik/pull/912) Preserve backwards compatibility for typoed `TYPE_ADJUSTEMENT` enum.
* [#911](https://github.com/erikwang2013/stripe-php-erik/pull/911) Codegenerated PHPDoc for nested resources
* [#902](https://github.com/erikwang2013/stripe-php-erik/pull/902) Update docstrings for nested resources

## 7.27.3 - 2020-03-18
* [#899](https://github.com/erikwang2013/stripe-php-erik/pull/899) Convert keys to strings in `StripeObject::toArray()`

## 7.27.2 - 2020-03-13
* [#894](https://github.com/erikwang2013/stripe-php-erik/pull/894) Multiple PHPDocs changes

## 7.27.1 - 2020-03-03
* [#890](https://github.com/erikwang2013/stripe-php-erik/pull/890) Update PHPdoc

## 7.27.0 - 2020-02-28
* [#889](https://github.com/erikwang2013/stripe-php-erik/pull/889) Add new constants for `type` on `TaxId`

## 7.26.0 - 2020-02-26
* [#886](https://github.com/erikwang2013/stripe-php-erik/pull/886) Add support for listing Checkout `Session`
* [#883](https://github.com/erikwang2013/stripe-php-erik/pull/883) Add PHPDoc class descriptions

## 7.25.0 - 2020-02-14
* [#879](https://github.com/erikwang2013/stripe-php-erik/pull/879) Make `\Stripe\Collection` implement `\Countable`
* [#875](https://github.com/erikwang2013/stripe-php-erik/pull/875) Last set of PHP-CS-Fixer updates
* [#874](https://github.com/erikwang2013/stripe-php-erik/pull/874) Enable php_unit_internal_class rule
* [#873](https://github.com/erikwang2013/stripe-php-erik/pull/873) Add support for phpDocumentor in Makefile
* [#872](https://github.com/erikwang2013/stripe-php-erik/pull/872) Another batch of PHP-CS-Fixer rule updates
* [#871](https://github.com/erikwang2013/stripe-php-erik/pull/871) Fix a few PHPDoc comments
* [#870](https://github.com/erikwang2013/stripe-php-erik/pull/870) More PHP-CS-Fixer tweaks

## 7.24.0 - 2020-02-10
* [#862](https://github.com/erikwang2013/stripe-php-erik/pull/862) Better PHPDoc
* [#865](https://github.com/erikwang2013/stripe-php-erik/pull/865) Get closer to `@PhpCsFixer` standard ruleset

## 7.23.0 - 2020-02-05
* [#860](https://github.com/erikwang2013/stripe-php-erik/pull/860) Add PHPDoc types for expandable fields
* [#858](https://github.com/erikwang2013/stripe-php-erik/pull/858) Use `native_function_invocation` PHPStan rule
* [#857](https://github.com/erikwang2013/stripe-php-erik/pull/857) Update PHPDoc on nested resources
* [#855](https://github.com/erikwang2013/stripe-php-erik/pull/855) PHPDoc: `StripeObject` -> `ErrorObject` where appropriate
* [#837](https://github.com/erikwang2013/stripe-php-erik/pull/837) Autogen diff
* [#854](https://github.com/erikwang2013/stripe-php-erik/pull/854) Upgrade PHPStan and fix settings
* [#850](https://github.com/erikwang2013/stripe-php-erik/pull/850) Yet more PHPDoc updates

## 7.22.0 - 2020-01-31
* [#849](https://github.com/erikwang2013/stripe-php-erik/pull/849) Add new constants for `type` on `TaxId`
* [#843](https://github.com/erikwang2013/stripe-php-erik/pull/843) Even more PHPDoc fixes
* [#841](https://github.com/erikwang2013/stripe-php-erik/pull/841) More PHPDoc fixes

## 7.21.1 - 2020-01-29
* [#840](https://github.com/erikwang2013/stripe-php-erik/pull/840) Update phpdocs across multiple resources.

## 7.21.0 - 2020-01-28
* [#839](https://github.com/erikwang2013/stripe-php-erik/pull/839) Add support for `TYPE_ES_CIF` on `TaxId`

## 7.20.0 - 2020-01-23
* [#836](https://github.com/erikwang2013/stripe-php-erik/pull/836) Add new type values for `TaxId`

## 7.19.1 - 2020-01-14
* [#831](https://github.com/erikwang2013/stripe-php-erik/pull/831) Fix incorrect `UnexpectedValueException` instantiation

## 7.19.0 - 2020-01-14
* [#830](https://github.com/erikwang2013/stripe-php-erik/pull/830) Add support for `CreditNoteLineItem`

## 7.18.0 - 2020-01-13
* [#829](https://github.com/erikwang2013/stripe-php-erik/pull/829) Don't call php_uname function if disabled by php.ini

## 7.17.0 - 2020-01-08
* [#821](https://github.com/erikwang2013/stripe-php-erik/pull/821) Improve PHPDoc types for `ApiErrorException.get/setJsonBody()` methods

## 7.16.0 - 2020-01-06
* [#826](https://github.com/erikwang2013/stripe-php-erik/pull/826) Rename remaining `$options` to `$opts`
* [#825](https://github.com/erikwang2013/stripe-php-erik/pull/825) Update PHPDoc

## 7.15.0 - 2020-01-06
* [#824](https://github.com/erikwang2013/stripe-php-erik/pull/824) Add constant `TYPE_SG_UEN` to `TaxId`

## 7.14.2 - 2019-12-04
* [#816](https://github.com/erikwang2013/stripe-php-erik/pull/816) Disable autoloader when checking for `Throwable`

## 7.14.1 - 2019-11-26
* [#812](https://github.com/erikwang2013/stripe-php-erik/pull/812) Fix invalid PHPdoc on `Subscription`

## 7.14.0 - 2019-11-26
* [#811](https://github.com/erikwang2013/stripe-php-erik/pull/811) Add support for `CreditNote` preview.

## 7.13.0 - 2019-11-19
* [#808](https://github.com/erikwang2013/stripe-php-erik/pull/808) Add support for listing lines on an Invoice directly via `Invoice::allLines()`

## 7.12.0 - 2019-11-08

-   [#805](https://github.com/erikwang2013/stripe-php-erik/pull/805) Add Source::allSourceTransactions and SubscriptionItem::allUsageRecordSummaries
-   [#798](https://github.com/erikwang2013/stripe-php-erik/pull/798) The argument of `array_key_exists` cannot be `null`
-   [#803](https://github.com/erikwang2013/stripe-php-erik/pull/803) Removed unwanted got

## 7.11.0 - 2019-11-06

-   [#797](https://github.com/erikwang2013/stripe-php-erik/pull/797) Add support for reverse pagination

## 7.10.0 - 2019-11-05

-   [#795](https://github.com/erikwang2013/stripe-php-erik/pull/795) Add support for `Mandate`

## 7.9.0 - 2019-11-05

-   [#794](https://github.com/erikwang2013/stripe-php-erik/pull/794) Add PHPDoc to `ApiResponse`
-   [#792](https://github.com/erikwang2013/stripe-php-erik/pull/792) Use single quotes for `OBJECT_NAME` constants

## 7.8.0 - 2019-11-05

-   [#790](https://github.com/erikwang2013/stripe-php-erik/pull/790) Mark nullable fields in PHPDoc
-   [#788](https://github.com/erikwang2013/stripe-php-erik/pull/788) Early codegen fixes
-   [#787](https://github.com/erikwang2013/stripe-php-erik/pull/787) Use PHPStan in Travis CI

## 7.7.1 - 2019-10-25

-   [#781](https://github.com/erikwang2013/stripe-php-erik/pull/781) Fix telemetry header
-   [#780](https://github.com/erikwang2013/stripe-php-erik/pull/780) Contributor Convenant

## 7.7.0 - 2019-10-23

-   [#776](https://github.com/erikwang2013/stripe-php-erik/pull/776) Add `CAPABILITY_TRANSFERS` to `Account`
-   [#778](https://github.com/erikwang2013/stripe-php-erik/pull/778) Add support for `TYPE_MX_RFC` type on `TaxId`

## 7.6.0 - 2019-10-22

-   [#770](https://github.com/erikwang2013/stripe-php-erik/pull/770) Add missing constants for Customer's `TaxId`

## 7.5.0 - 2019-10-18

-   [#768](https://github.com/erikwang2013/stripe-php-erik/pull/768) Redact API key in `RequestOptions` debug info

## 7.4.0 - 2019-10-15

-   [#764](https://github.com/erikwang2013/stripe-php-erik/pull/764) Add support for HTTP request monitoring callback

## 7.3.1 - 2019-10-07

-   [#755](https://github.com/erikwang2013/stripe-php-erik/pull/755) Respect Stripe-Should-Retry and Retry-After headers

## 7.3.0 - 2019-10-02

-   [#752](https://github.com/erikwang2013/stripe-php-erik/pull/752) Add `payment_intent.canceled` and `setup_intent.canceled` events
-   [#749](https://github.com/erikwang2013/stripe-php-erik/pull/749) Call `toArray()` on objects only

## 7.2.2 - 2019-09-24

-   [#746](https://github.com/erikwang2013/stripe-php-erik/pull/746) Add missing decline codes

## 7.2.1 - 2019-09-23

-   [#744](https://github.com/erikwang2013/stripe-php-erik/pull/744) Added new PHPDoc

## 7.2.0 - 2019-09-17

-   [#738](https://github.com/erikwang2013/stripe-php-erik/pull/738) Added missing constants for `SetupIntent` events

## 7.1.1 - 2019-09-16

-   [#737](https://github.com/erikwang2013/stripe-php-erik/pull/737) Added new PHPDoc

## 7.1.0 - 2019-09-13

-   [#736](https://github.com/erikwang2013/stripe-php-erik/pull/736) Make `CaseInsensitiveArray` countable and traversable

## 7.0.2 - 2019-09-06

-   [#729](https://github.com/erikwang2013/stripe-php-erik/pull/729) Fix usage of `SignatureVerificationException` in PHPDoc blocks

## 7.0.1 - 2019-09-05

-   [#728](https://github.com/erikwang2013/stripe-php-erik/pull/728) Clean up Collection

## 7.0.0 - 2019-09-03

Major version release. The [migration guide](https://github.com/erikwang2013/stripe-php-erik/wiki/Migration-guide-for-v7) contains a detailed list of backwards-incompatible changes with upgrade instructions.

Pull requests included in this release (cf. [#552](https://github.com/erikwang2013/stripe-php-erik/pull/552)) (⚠️ = breaking changes):

-   ⚠️ Drop support for PHP 5.4 ([#551](https://github.com/erikwang2013/stripe-php-erik/pull/551))
-   ⚠️ Drop support for PHP 5.5 ([#554](https://github.com/erikwang2013/stripe-php-erik/pull/554))
-   Bump dependencies ([#553](https://github.com/erikwang2013/stripe-php-erik/pull/553))
-   Remove `CURLFile` check ([#555](https://github.com/erikwang2013/stripe-php-erik/pull/555))
-   Update constant definitions for PHP >= 5.6 ([#556](https://github.com/erikwang2013/stripe-php-erik/pull/556))
-   ⚠️ Remove `FileUpload` alias ([#557](https://github.com/erikwang2013/stripe-php-erik/pull/557))
-   Remove `curl_reset` check ([#570](https://github.com/erikwang2013/stripe-php-erik/pull/570))
-   Use `\Stripe\<class>::class` constant instead of strings ([#643](https://github.com/erikwang2013/stripe-php-erik/pull/643))
-   Use `array_column` to flatten params ([#686](https://github.com/erikwang2013/stripe-php-erik/pull/686))
-   ⚠️ Remove deprecated methods ([#692](https://github.com/erikwang2013/stripe-php-erik/pull/692))
-   ⚠️ Remove `IssuerFraudRecord` ([#696](https://github.com/erikwang2013/stripe-php-erik/pull/696))
-   Update constructors of Stripe exception classes ([#559](https://github.com/erikwang2013/stripe-php-erik/pull/559))
-   Fix remaining TODOs ([#700](https://github.com/erikwang2013/stripe-php-erik/pull/700))
-   Use yield for autopagination ([#703](https://github.com/erikwang2013/stripe-php-erik/pull/703))
-   ⚠️ Rename fake magic methods and rewrite array conversion ([#704](https://github.com/erikwang2013/stripe-php-erik/pull/704))
-   Add `ErrorObject` to Stripe exceptions ([#705](https://github.com/erikwang2013/stripe-php-erik/pull/705))
-   Start using PHP CS Fixer ([#706](https://github.com/erikwang2013/stripe-php-erik/pull/706))
-   Update error messages for nested resource operations ([#708](https://github.com/erikwang2013/stripe-php-erik/pull/708))
-   Upgrade retry logic ([#707](https://github.com/erikwang2013/stripe-php-erik/pull/707))
-   ⚠️ `Collection` improvements / fixes ([#715](https://github.com/erikwang2013/stripe-php-erik/pull/715))
-   ⚠️ Modernize exceptions ([#709](https://github.com/erikwang2013/stripe-php-erik/pull/709))
-   Add constants for error codes ([#716](https://github.com/erikwang2013/stripe-php-erik/pull/716))
-   Update certificate bundle ([#717](https://github.com/erikwang2013/stripe-php-erik/pull/717))
-   Retry requests on a 429 that's a lock timeout ([#718](https://github.com/erikwang2013/stripe-php-erik/pull/718))
-   Fix `toArray()` calls ([#719](https://github.com/erikwang2013/stripe-php-erik/pull/719))
-   Couple of fixes for PHP 7.4 ([#725](https://github.com/erikwang2013/stripe-php-erik/pull/725))

## 6.43.1 - 2019-08-29

-   [#722](https://github.com/erikwang2013/stripe-php-erik/pull/722) Make `LoggerInterface::error` compatible with its PSR-3 counterpart
-   [#714](https://github.com/erikwang2013/stripe-php-erik/pull/714) Add `pending_setup_intent` property in `Subscription`
-   [#713](https://github.com/erikwang2013/stripe-php-erik/pull/713) Add typehint to `ApiResponse`
-   [#712](https://github.com/erikwang2013/stripe-php-erik/pull/712) Fix comment
-   [#701](https://github.com/erikwang2013/stripe-php-erik/pull/701) Start testing PHP 7.3

## 6.43.0 - 2019-08-09

-   [#694](https://github.com/erikwang2013/stripe-php-erik/pull/694) Add `SubscriptionItem::createUsageRecord` method

## 6.42.0 - 2019-08-09

-   [#688](https://github.com/erikwang2013/stripe-php-erik/pull/688) Remove `SubscriptionScheduleRevision`
    -   Note that this is technically a breaking change, however we've chosen to release it as a minor version in light of the fact that this resource and its API methods were virtually unused.

## 6.41.0 - 2019-07-31

-   [#683](https://github.com/erikwang2013/stripe-php-erik/pull/683) Move the List Balance History API to `/v1/balance_transactions`

## 6.40.0 - 2019-06-27

-   [#675](https://github.com/erikwang2013/stripe-php-erik/pull/675) Add support for `SetupIntent` resource and APIs

## 6.39.2 - 2019-06-26

-   [#676](https://github.com/erikwang2013/stripe-php-erik/pull/676) Fix exception message in `CustomerBalanceTransaction::update()`

## 6.39.1 - 2019-06-25

-   [#674](https://github.com/erikwang2013/stripe-php-erik/pull/674) Add new constants for `collection_method` on `Invoice`

## 6.39.0 - 2019-06-24

-   [#673](https://github.com/erikwang2013/stripe-php-erik/pull/673) Enable request latency telemetry by default

## 6.38.0 - 2019-06-17

-   [#649](https://github.com/erikwang2013/stripe-php-erik/pull/649) Add support for `CustomerBalanceTransaction` resource and APIs

## 6.37.2 - 2019-06-17

-   [#671](https://github.com/erikwang2013/stripe-php-erik/pull/671) Add new PHPDoc
-   [#672](https://github.com/erikwang2013/stripe-php-erik/pull/672) Add constants for `submit_type` on Checkout `Session`

## 6.37.1 - 2019-06-14

-   [#670](https://github.com/erikwang2013/stripe-php-erik/pull/670) Add new PHPDoc

## 6.37.0 - 2019-05-23

-   [#663](https://github.com/erikwang2013/stripe-php-erik/pull/663) Add support for `radar.early_fraud_warning` resource

## 6.36.0 - 2019-05-22

-   [#661](https://github.com/erikwang2013/stripe-php-erik/pull/661) Add constants for new TaxId types
-   [#662](https://github.com/erikwang2013/stripe-php-erik/pull/662) Add constants for BalanceTransaction types

## 6.35.2 - 2019-05-20

-   [#655](https://github.com/erikwang2013/stripe-php-erik/pull/655) Add constants for payment intent statuses
-   [#659](https://github.com/erikwang2013/stripe-php-erik/pull/659) Fix PHPDoc for various nested Account actions
-   [#660](https://github.com/erikwang2013/stripe-php-erik/pull/660) Fix various PHPDoc

## 6.35.1 - 2019-05-20

-   [#658](https://github.com/erikwang2013/stripe-php-erik/pull/658) Use absolute value when checking timestamp tolerance

## 6.35.0 - 2019-05-14

-   [#651](https://github.com/erikwang2013/stripe-php-erik/pull/651) Add support for the Capability resource and APIs

## 6.34.6 - 2019-05-13

-   [#654](https://github.com/erikwang2013/stripe-php-erik/pull/654) Fix typo in definition of `Event::PAYMENT_METHOD_ATTACHED` constant

## 6.34.5 - 2019-05-06

-   [#647](https://github.com/erikwang2013/stripe-php-erik/pull/647) Set the return type to static for more operations

## 6.34.4 - 2019-05-06

-   [#650](https://github.com/erikwang2013/stripe-php-erik/pull/650) Add missing constants for Event types

## 6.34.3 - 2019-05-01

-   [#644](https://github.com/erikwang2013/stripe-php-erik/pull/644) Update return type to `static` to improve static analysis
-   [#645](https://github.com/erikwang2013/stripe-php-erik/pull/645) Fix constant for `payment_intent.payment_failed`

## 6.34.2 - 2019-04-26

-   [#642](https://github.com/erikwang2013/stripe-php-erik/pull/642) Fix an issue where existing idempotency keys would be overwritten when using automatic retries

## 6.34.1 - 2019-04-25

-   [#640](https://github.com/erikwang2013/stripe-php-erik/pull/640) Add missing phpdocs

## 6.34.0 - 2019-04-24

-   [#626](https://github.com/erikwang2013/stripe-php-erik/pull/626) Add support for the `TaxRate` resource and APIs
-   [#639](https://github.com/erikwang2013/stripe-php-erik/pull/639) Fix multiple phpdoc issues

## 6.33.0 - 2019-04-22

-   [#630](https://github.com/erikwang2013/stripe-php-erik/pull/630) Add support for the `TaxId` resource and APIs

## 6.32.1 - 2019-04-19

-   [#636](https://github.com/erikwang2013/stripe-php-erik/pull/636) Correct type of `$personId` in PHPDoc

## 6.32.0 - 2019-04-18

-   [#621](https://github.com/erikwang2013/stripe-php-erik/pull/621) Add support for `CreditNote`

## 6.31.5 - 2019-04-12

-   [#628](https://github.com/erikwang2013/stripe-php-erik/pull/628) Add constants for `person.*` event types
-   [#628](https://github.com/erikwang2013/stripe-php-erik/pull/628) Add missing constants for `Account` and `Person`

## 6.31.4 - 2019-04-05

-   [#624](https://github.com/erikwang2013/stripe-php-erik/pull/624) Fix encoding of nested parameters in multipart requests

## 6.31.3 - 2019-04-02

-   [#623](https://github.com/erikwang2013/stripe-php-erik/pull/623) Only use HTTP/2 with curl >= 7.60.0

## 6.31.2 - 2019-03-25

-   [#619](https://github.com/erikwang2013/stripe-php-erik/pull/619) Fix PHPDoc return types for list methods for nested resources

## 6.31.1 - 2019-03-22

-   [#612](https://github.com/erikwang2013/stripe-php-erik/pull/612) Add a lot of constants
-   [#614](https://github.com/erikwang2013/stripe-php-erik/pull/614) Add missing subscription status constants

## 6.31.0 - 2019-03-18

-   [#600](https://github.com/erikwang2013/stripe-php-erik/pull/600) Add support for the `PaymentMethod` resource and APIs
-   [#606](https://github.com/erikwang2013/stripe-php-erik/pull/606) Add support for retrieving a Checkout `Session`
-   [#611](https://github.com/erikwang2013/stripe-php-erik/pull/611) Add support for deleting a Terminal `Location` and `Reader`

## 6.30.5 - 2019-03-11

-   [#607](https://github.com/erikwang2013/stripe-php-erik/pull/607) Correctly handle case where a metadata key is called `metadata`

## 6.30.4 - 2019-02-27

-   [#602](https://github.com/erikwang2013/stripe-php-erik/pull/602) Add `subscription_schedule` to `Subscription` for PHPDoc.

## 6.30.3 - 2019-02-26

-   [#603](https://github.com/erikwang2013/stripe-php-erik/pull/603) Improve PHPDoc on the `Source` object to cover all types of Sources currently supported.

## 6.30.2 - 2019-02-25

-   [#601](https://github.com/erikwang2013/stripe-php-erik/pull/601) Fix PHPDoc across multiple resources and add support for new events.

## 6.30.1 - 2019-02-16

-   [#599](https://github.com/erikwang2013/stripe-php-erik/pull/599) Fix PHPDoc for `SubscriptionSchedule` and `SubscriptionScheduleRevision`

## 6.30.0 - 2019-02-12

-   [#590](https://github.com/erikwang2013/stripe-php-erik/pull/590) Add support for `SubscriptionSchedule` and `SubscriptionScheduleRevision`

## 6.29.3 - 2019-01-31

-   [#592](https://github.com/erikwang2013/stripe-php-erik/pull/592) Some more PHPDoc fixes

## 6.29.2 - 2019-01-31

-   [#591](https://github.com/erikwang2013/stripe-php-erik/pull/591) Fix PHPDoc for nested resources

## 6.29.1 - 2019-01-25

-   [#566](https://github.com/erikwang2013/stripe-php-erik/pull/566) Fix dangling message contents
-   [#586](https://github.com/erikwang2013/stripe-php-erik/pull/586) Don't overwrite `CURLOPT_HTTP_VERSION` option

## 6.29.0 - 2019-01-23

-   [#579](https://github.com/erikwang2013/stripe-php-erik/pull/579) Rename `CheckoutSession` to `Session` and move it under the `Checkout` namespace. This is a breaking change, but we've reached out to affected merchants and all new merchants would use the new approach.

## 6.28.1 - 2019-01-21

-   [#580](https://github.com/erikwang2013/stripe-php-erik/pull/580) Properly serialize `individual` on `Account` objects

## 6.28.0 - 2019-01-03

-   [#576](https://github.com/erikwang2013/stripe-php-erik/pull/576) Add support for iterating directly over `Collection` instances

## 6.27.0 - 2018-12-21

-   [#571](https://github.com/erikwang2013/stripe-php-erik/pull/571) Add support for the `CheckoutSession` resource

## 6.26.0 - 2018-12-11

-   [#568](https://github.com/erikwang2013/stripe-php-erik/pull/568) Enable persistent connections

## 6.25.0 - 2018-12-10

-   [#567](https://github.com/erikwang2013/stripe-php-erik/pull/567) Add support for account links

## 6.24.0 - 2018-11-28

-   [#562](https://github.com/erikwang2013/stripe-php-erik/pull/562) Add support for the Review resource
-   [#564](https://github.com/erikwang2013/stripe-php-erik/pull/564) Add event name constants for subscription schedule aborted/expiring

## 6.23.0 - 2018-11-27

-   [#542](https://github.com/erikwang2013/stripe-php-erik/pull/542) Add support for `ValueList` and `ValueListItem` for Radar

## 6.22.1 - 2018-11-20

-   [#561](https://github.com/erikwang2013/stripe-php-erik/pull/561) Add cast and some docs to telemetry introduced in 6.22.0/549

## 6.22.0 - 2018-11-15

-   [#549](https://github.com/erikwang2013/stripe-php-erik/pull/549) Add support for client telemetry

## 6.21.1 - 2018-11-12

-   [#548](https://github.com/erikwang2013/stripe-php-erik/pull/548) Don't mutate `Exception` class properties from `OAuthBase` error

## 6.21.0 - 2018-11-08

-   [#537](https://github.com/erikwang2013/stripe-php-erik/pull/537) Add new API endpoints for the `Invoice` resource.

## 6.20.1 - 2018-11-07

-   [#546](https://github.com/erikwang2013/stripe-php-erik/pull/546) Drop files from the Composer package that aren't needed in the release

## 6.20.0 - 2018-10-30

-   [#536](https://github.com/erikwang2013/stripe-php-erik/pull/536) Add support for the `Person` resource
-   [#541](https://github.com/erikwang2013/stripe-php-erik/pull/541) Add support for the `WebhookEndpoint` resource

## 6.19.5 - 2018-10-17

-   [#539](https://github.com/erikwang2013/stripe-php-erik/pull/539) Fix methods on `\Stripe\PaymentIntent` to properly pass arguments to the API.

## 6.19.4 - 2018-10-11

-   [#534](https://github.com/erikwang2013/stripe-php-erik/pull/534) Fix PSR-4 autoloading for `\Stripe\FileUpload` class alias

## 6.19.3 - 2018-10-09

-   [#530](https://github.com/erikwang2013/stripe-php-erik/pull/530) Add constants for `flow` (`FLOW_*`), `status` (`STATUS_*`) and `usage` (`USAGE_*`) on `\Stripe\Source`

## 6.19.2 - 2018-10-08

-   [#531](https://github.com/erikwang2013/stripe-php-erik/pull/531) Store HTTP response headers in case-insensitive array

## 6.19.1 - 2018-09-25

-   [#526](https://github.com/erikwang2013/stripe-php-erik/pull/526) Ignore null values in request parameters

## 6.19.0 - 2018-09-24

-   [#523](https://github.com/erikwang2013/stripe-php-erik/pull/523) Add support for Stripe Terminal

## 6.18.0 - 2018-09-24

-   [#520](https://github.com/erikwang2013/stripe-php-erik/pull/520) Rename `\Stripe\FileUpload` to `\Stripe\File`

## 6.17.2 - 2018-09-18

-   [#522](https://github.com/erikwang2013/stripe-php-erik/pull/522) Fix warning when adding a new additional owner to an existing array

## 6.17.1 - 2018-09-14

-   [#517](https://github.com/erikwang2013/stripe-php-erik/pull/517) Integer-index encode all sequential arrays

## 6.17.0 - 2018-09-05

-   [#514](https://github.com/erikwang2013/stripe-php-erik/pull/514) Add support for reporting resources

## 6.16.0 - 2018-08-23

-   [#509](https://github.com/erikwang2013/stripe-php-erik/pull/509) Add support for usage record summaries

## 6.15.0 - 2018-08-03

-   [#504](https://github.com/erikwang2013/stripe-php-erik/pull/504) Add cancel support for topups

## 6.14.0 - 2018-08-02

-   [#505](https://github.com/erikwang2013/stripe-php-erik/pull/505) Add support for file links

## 6.13.0 - 2018-07-31

-   [#502](https://github.com/erikwang2013/stripe-php-erik/pull/502) Add `isDeleted()` method to `\Stripe\StripeObject`

## 6.12.0 - 2018-07-28

-   [#501](https://github.com/erikwang2013/stripe-php-erik/pull/501) Add support for scheduled query runs (`\Stripe\Sigma\ScheduledQueryRun`) for Sigma

## 6.11.0 - 2018-07-26

-   [#500](https://github.com/erikwang2013/stripe-php-erik/pull/500) Add support for Stripe Issuing

## 6.10.4 - 2018-07-19

-   [#498](https://github.com/erikwang2013/stripe-php-erik/pull/498) Internal improvements to the `\Stripe\ApiResource.classUrl()` method

## 6.10.3 - 2018-07-16

-   [#497](https://github.com/erikwang2013/stripe-php-erik/pull/497) Use HTTP/2 only for HTTPS requests

## 6.10.2 - 2018-07-11

-   [#494](https://github.com/erikwang2013/stripe-php-erik/pull/494) Enable HTTP/2 support

## 6.10.1 - 2018-07-10

-   [#493](https://github.com/erikwang2013/stripe-php-erik/pull/493) Add PHPDoc for `auto_advance` on `\Stripe\Invoice`

## 6.10.0 - 2018-06-28

-   [#488](https://github.com/erikwang2013/stripe-php-erik/pull/488) Add support for `$appPartnerId` to `Stripe::setAppInfo()`

## 6.9.0 - 2018-06-28

-   [#487](https://github.com/erikwang2013/stripe-php-erik/pull/487) Add support for payment intents

## 6.8.2 - 2018-06-24

-   [#486](https://github.com/erikwang2013/stripe-php-erik/pull/486) Make `Account.deauthorize()` return the `StripeObject` from the API

## 6.8.1 - 2018-06-13

-   [#472](https://github.com/erikwang2013/stripe-php-erik/pull/472) Added phpDoc for `ApiRequestor` and others, especially regarding thrown errors

## 6.8.0 - 2018-06-13

-   [#481](https://github.com/erikwang2013/stripe-php-erik/pull/481) Add new `\Stripe\Discount` and `\Stripe\OrderItem` classes, add more PHPDoc describing object attributes

## 6.7.4 - 2018-05-29

-   [#480](https://github.com/erikwang2013/stripe-php-erik/pull/480) PHPDoc changes for API version 2018-05-21 and the addition of the new `CHARGE_EXPIRED` event type

## 6.7.3 - 2018-05-28

-   [#479](https://github.com/erikwang2013/stripe-php-erik/pull/479) Fix unnecessary traits on `\Stripe\InvoiceLineItem`

## 6.7.2 - 2018-05-28

-   [#471](https://github.com/erikwang2013/stripe-php-erik/pull/471) Add `OBJECT_NAME` constant to all API resource classes, add `\Stripe\InvoiceLineItem` class

## 6.7.1 - 2018-05-13

-   [#468](https://github.com/erikwang2013/stripe-php-erik/pull/468) Update fields in PHP docs for accuracy

## 6.7.0 - 2018-05-09

-   [#466](https://github.com/erikwang2013/stripe-php-erik/pull/466) Add support for issuer fraud records

## 6.6.0 - 2018-04-11

-   [#460](https://github.com/erikwang2013/stripe-php-erik/pull/460) Add support for flexible billing primitives

## 6.5.0 - 2018-04-05

-   [#461](https://github.com/erikwang2013/stripe-php-erik/pull/461) Don't zero keys on non-`metadata` subobjects

## 6.4.2 - 2018-03-17

-   [#458](https://github.com/erikwang2013/stripe-php-erik/pull/458) Add PHPDoc for `account` on `\Stripe\Event`

## 6.4.1 - 2018-03-02

-   [#455](https://github.com/erikwang2013/stripe-php-erik/pull/455) Fix namespaces in PHPDoc
-   [#456](https://github.com/erikwang2013/stripe-php-erik/pull/456) Fix namespaces for some exceptions

## 6.4.0 - 2018-02-28

-   [#453](https://github.com/erikwang2013/stripe-php-erik/pull/453) Add constants for `reason` (`REASON_*`) and `status` (`STATUS_*`) on `\Stripe\Dispute`

## 6.3.2 - 2018-02-27

-   [#452](https://github.com/erikwang2013/stripe-php-erik/pull/452) Add PHPDoc for `amount_paid` and `amount_remaining` on `\Stripe\Invoice`

## 6.3.1 - 2018-02-26

-   [#443](https://github.com/erikwang2013/stripe-php-erik/pull/443) Add event types as constants to `\Stripe\Event` class

## 6.3.0 - 2018-02-23

-   [#450](https://github.com/erikwang2013/stripe-php-erik/pull/450) Add support for `code` attribute on all Stripe exceptions

## 6.2.0 - 2018-02-21

-   [#440](https://github.com/erikwang2013/stripe-php-erik/pull/440) Add support for topups
-   [#442](https://github.com/erikwang2013/stripe-php-erik/pull/442) Fix PHPDoc for `\Stripe\Error\SignatureVerification`

## 6.1.0 - 2018-02-12

-   [#435](https://github.com/erikwang2013/stripe-php-erik/pull/435) Fix header persistence on `Collection` objects
-   [#436](https://github.com/erikwang2013/stripe-php-erik/pull/436) Introduce new `Idempotency` error class
...
-   [#410](https://github.com/erikwang2013/stripe-php-erik/pull/410) Drop support for PHP 5.3
-   [#411](https://github.com/erikwang2013/stripe-php-erik/pull/411) Use traits for common API operations
-   [#414](https://github.com/erikwang2013/stripe-php-erik/pull/414) Use short array syntax
-   [#404](https://github.com/erikwang2013/stripe-php-erik/pull/404) Fix serialization logic
-   [#417](https://github.com/erikwang2013/stripe-php-erik/pull/417) Remove `ExternalAccount` class
-   [#418](https://github.com/erikwang2013/stripe-php-erik/pull/418) Increase test coverage
-   [#421](https://github.com/erikwang2013/stripe-php-erik/pull/421) Update CA bundle and add script for future updates
-   [#422](https://github.com/erikwang2013/stripe-php-erik/pull/422) Use vendored CA bundle for all requests
-   [#428](https://github.com/erikwang2013/stripe-php-erik/pull/428) Support for automatic request retries

## 5.9.2 - 2018-02-07

-   [#431](https://github.com/erikwang2013/stripe-php-erik/pull/431) Update PHPDoc @property tags for latest API version

## 5.9.1 - 2018-02-06

-   [#427](https://github.com/erikwang2013/stripe-php-erik/pull/427) Add and update PHPDoc @property tags on all API resources

## 5.9.0 - 2018-01-17

-   [#421](https://github.com/erikwang2013/stripe-php-erik/pull/421) Updated bundled CA certificates
-   [#423](https://github.com/erikwang2013/stripe-php-erik/pull/423) Escape unsanitized input in OAuth example

## 5.8.0 - 2017-12-20

-   [#403](https://github.com/erikwang2013/stripe-php-erik/pull/403) Add `__debugInfo()` magic method to `StripeObject`

## 5.7.0 - 2017-11-28

-   [#390](https://github.com/erikwang2013/stripe-php-erik/pull/390) Remove some unsupported API methods
-   [#391](https://github.com/erikwang2013/stripe-php-erik/pull/391) Alphabetize the list of API resources in `Util::convertToStripeObject()` and add missing resources
-   [#393](https://github.com/erikwang2013/stripe-php-erik/pull/393) Fix expiry date update for card sources

## 5.6.0 - 2017-10-31

-   [#386](https://github.com/erikwang2013/stripe-php-erik/pull/386) Support for exchange rates APIs

## 5.5.1 - 2017-10-30

-   [#387](https://github.com/erikwang2013/stripe-php-erik/pull/387) Allow `personal_address_kana` and `personal_address_kanji` to be updated on an account

## 5.5.0 - 2017-10-27

-   [#385](https://github.com/erikwang2013/stripe-php-erik/pull/385) Support for listing source transactions

## 5.4.0 - 2017-10-24

-   [#383](https://github.com/erikwang2013/stripe-php-erik/pull/383) Add static methods to manipulate resources from parent
...
-   [#378](https://github.com/erikwang2013/stripe-php-erik/pull/378) Rename source `delete` to `detach` (and deprecate the former)
