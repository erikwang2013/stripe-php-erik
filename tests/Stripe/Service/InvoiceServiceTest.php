 ...
 * @internal
 *
 * @covers \Erikwang2013\Stripe\Service\InvoiceService
 */
final class InvoiceServiceTest extends \Erikwang2013\Stripe\TestCase
{
    ...
    public function testAll()
    {
        ...
        self::assertInstanceOf(\Erikwang2013\Stripe\Invoice::class, $resources->data[0]);
    }
    ...
    public function testCreate()
    {
        ...
        self::assertInstanceOf(\Erikwang2013\Stripe\Invoice::class, $resource);
    }
