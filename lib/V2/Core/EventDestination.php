 ...
 * @property null|(object{aws_account_id: string, aws_event_source_arn: string, aws_event_source_status: string}&\Erikwang2013\Stripe\StripeObject) $amazon_eventbridge Amazon EventBridge configuration.
 ...
 * @property null|\Erikwang2013\Stripe\StripeObject $metadata Metadata.
 ...
 * @property null|(object{disabled?: (object{reason: string}&\Erikwang2013\Stripe\StripeObject)}&\Erikwang2013\Stripe\StripeObject) $status_details Additional information about event destination status.
 * @property string $type Event destination type.
 * @property int $updated Time at which the object was last updated.
 * @property null|(object{signing_secret?: string, url?: string}&\Erikwang2013\Stripe\StripeObject) $webhook_endpoint Webhook endpoint configuration.
 */
class EventDestination extends \Erikwang2013\Stripe\ApiResource
{
