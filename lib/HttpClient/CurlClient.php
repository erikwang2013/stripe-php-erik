...
use Erikwang2013\Stripe\Exception;
use Erikwang2013\Stripe\Stripe;
use Erikwang2013\Stripe\Util;
...
class CurlClient implements ClientInterface, StreamingClientInterface
{
     ...
     *   <li>\Erikwang2013\Stripe\Util\CaseInsensitiveArray $rheaders The response headers</li>
    ...
    private function constructCurlOptions($method, $absUrl, $headers, $body, $opts, $apiMode)
    {
        ...
        // inspired by https://github.com/erikwang2013/stripe-php-erik/issues/1817#issuecomment-2670463182
