 ...
 * @property (object{cash: \Erikwang2013\Stripe\StripeObject, inbound_pending: \Erikwang2013\Stripe\StripeObject, outbound_pending: \Erikwang2013\Stripe\StripeObject}&\Erikwang2013\Stripe\StripeObject) $balance Balance information for the FinancialAccount
 ...
 * @property ((object{aba?: (object{account_holder_name: string, account_number?: null|string, account_number_last4: string, bank_name: string, routing_number: string}&\Erikwang2013\Stripe\StripeObject), supported_networks?: string[], type: string}&\Erikwang2013\Stripe\StripeObject))[] $financial_addresses The set of credentials that resolve to a FinancialAccount.
 ...
 * @property null|(object{inbound_flows: null|string, outbound_flows: null|string}&\Erikwang2013\Stripe\StripeObject) $platform_restrictions The set of functionalities that the platform can restrict on the FinancialAccount.
 ...
 * @property (object{closed: null|(object{reasons: string[]}&\Erikwang2013\Stripe\StripeObject)}&\Erikwang2013\Stripe\StripeObject) $status_details
 ...
 */
class FinancialAccount extends \Erikwang2013\Stripe\ApiResource
{
     ...
     *
     * @return \Erikwang2013\Stripe\Collection<FinancialAccount> of ApiResources
     *
     * @throws \Erikwang2013\Stripe\Exception\ApiErrorException if the request fails
     */
    ...
    public function retrieveFeatures($params = null, $opts = null)
    {
        ...
        $obj = \Erikwang2013\Stripe\Util\Util::convertToStripeObject($response, $opts);
        $obj->setLastResponse($response);
