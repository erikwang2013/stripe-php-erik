 ...
 * @property null|(object{billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\Erikwang2013\Stripe\StripeObject), email: null|string, name: null|string}&\Erikwang2013\Stripe\StripeObject), financial_account?: (object{id: string, network: string}&\Erikwang2013\Stripe\StripeObject), type: string, us_bank_account?: (object{account_holder_type: null|string, account_type: null|string, bank_name: null|string, fingerprint: null|string, last4: null|string, mandate?: string|\Erikwang2013\Stripe\Mandate, network: string, routing_number: null|string}&\Erikwang2013\Stripe\StripeObject)}&\Erikwang2013\Stripe\StripeObject) $destination_payment_method_details Details about the PaymentMethod for an OutboundPayment.
 * @property null|(object{ip_address: null|string, present: bool}&\Erikwang2013\Stripe\StripeObject) $end_user_details Details about the end user.
 ...
 * @property null|(object{code: string, transaction: string|Transaction}&\Erikwang2013\Stripe\StripeObject) $returned_details Details about a returned OutboundPayment. Only set when the status is <code>returned</code>.
 ...
 */
class OutboundPayment extends \Erikwang2013\Stripe\ApiResource
{
     ...
     *
     * @return \Erikwang2013\Stripe\Collection<OutboundPayment> of ApiResources
     *
     * @throws \Erikwang2013\Stripe\Exception\ApiErrorException if the request fails
     */
