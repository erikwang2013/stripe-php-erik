 ...
 * @property null|(object{code: string}&\Erikwang2013\Stripe\StripeObject) $failure_details Details about this InboundTransfer's failure. Only set when status is <code>failed</code>.
 ...
 * @property (object{received_debit: null|string}&\Erikwang2013\Stripe\StripeObject) $linked_flows
 ...
 * @property null|(object{billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\Erikwang2013\Stripe\StripeObject), email: null|string, name: null|string}&\Erikwang2013\Stripe\StripeObject), type: string, us_bank_account?: (object{account_holder_type: null|string, account_type: null|string, bank_name: null|string, fingerprint: null|string, last4: null|string, mandate?: string|\Erikwang2013\Stripe\Mandate, network: string, routing_number: null|string}&\Erikwang2013\Stripe\StripeObject)}&\Erikwang2013\Stripe\StripeObject) $origin_payment_method_details Details about the PaymentMethod for an InboundTransfer.
 ...
 * @property (object{canceled_at?: null|int, failed_at: null|int, succeeded_at: null|int}&\Erikwang2013\Stripe\StripeObject) $status_transitions
 * @property null|string|Transaction $transaction The Transaction associated with this object.
 */
class InboundTransfer extends \Erikwang2013\Stripe\ApiResource
{
     ...
     *
     * @return \Erikwang2013\Stripe\Collection<InboundTransfer> of ApiResources
     *
     * @throws \Erikwang2013\Stripe\Exception\ApiErrorException if the request fails
     */
