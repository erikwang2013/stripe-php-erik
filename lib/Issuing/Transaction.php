 ...
 * @property null|string|\Erikwang2013\Stripe\BalanceTransaction $balance_transaction ID of the <a href="https://docs.stripe.com/api/balance_transactions">balance transaction</a> associated with this transaction.
 ...
 * @property null|(object{authorization_code: null|string, processing_date: null|string, transaction_id: null|string}&\Erikwang2013\Stripe\StripeObject) $network_data Details about the transaction, such as processing dates, set by the card network.
 * @property null|(object{fleet: null|(object{cardholder_prompt_data: null|(object{driver_id: null|string, odometer: null|int, unspecified_id: null|string, user_id: null|string, vehicle_number: null|string}&\Erikwang2013\Stripe\StripeObject), purchase_type: null|string, reported_breakdown: null|(object{fuel: null|(object{gross_amount_decimal: null|string}&\Erikwang2013\Stripe\StripeObject), non_fuel: null|(object{gross_amount_decimal: null|string}&\Erikwang2013\Stripe\StripeObject), tax: null|(object{local_amount_decimal: null|string, national_amount_decimal: null|string}&\Erikwang2013\Stripe\StripeObject)}&\Erikwang2013\Stripe\StripeObject), service_type: null|string}&\Erikwang2013\Stripe\StripeObject), flight: null|(object{departure_at: null|int, passenger_name: null|string, refundable: null|bool, segments: null|((object{arrival_airport_code: null|string, carrier: null|string, departure_airport_code: null|string, flight_number: null|string, service_class: null|string, stopover_allowed: null|bool}&\Erikwang2013\Stripe\StripeObject))[], travel_agency: null|string}&\Erikwang2013\Stripe\StripeObject), fuel: null|(object{industry_product_code: null|string, quantity_decimal: null|string, type: string, unit: string, unit_cost_decimal: string}&\Erikwang2013\Stripe\StripeObject), lodging: null|(object{check_in_at: null|int, nights: null|int}&\Erikwang2013\Stripe\StripeObject), receipt: null|((object{description: null|string, quantity: null|float, total: null|int, unit_cost: null|int}&\Erikwang2013\Stripe\StripeObject))[], reference: null|string}&\Erikwang2013\Stripe\StripeObject) $purchase_details Additional purchase information that is optionally provided by the merchant.
 ...
 * @property null|(object{received_credit: null|string, received_debit: null|string}&\Erikwang2013\Stripe\StripeObject) $treasury <a href="https://docs.stripe.com/api/treasury">Treasury</a> details related to this transaction if it was created on a [FinancialAccount](/docs/api/treasury/financial_accounts
