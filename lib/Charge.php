 ...
 * PaymentIntent confirmation is the most common way to create Charges, but <a href="https://docs.stripe.com/connect/account-debits">Account Debits</a> may also create Charges.
 ...
 * @property null|ApplicationFee|string $application_fee The application fee (if any) for the charge. <a href="https://docs.stripe.com/connect/direct-charges#collect-fees">See the Connect documentation</a> for details.
 * @property null|int $application_fee_amount The amount of the application fee (if any) requested for the charge. <a href="https://docs.stripe.com/connect/direct-charges#collect-fees">See the Connect documentation</a> for details.
 ...
 * @property null|string $failure_code Error code explaining reason for charge failure if available (see <a href="https://docs.stripe.com/error-codes">the errors section</a> for a list of codes).
 ...
 * @property null|Account|string $on_behalf_of The account (if any) the charge was made on behalf of without triggering an automatic transfer. See the <a href="https://docs.stripe.com/connect/separate-charges-and-transfers">Connect documentation</a> for details.
 * @property null|(object{advice_code: null|string, network_advice_code: null|string, network_decline_code: null|string, network_status: null|string, reason: null|string, risk_level?: string, risk_score?: int, rule?: (object{action: string, id: string, predicate: string}&StripeObject)|string, seller_message: null|string, type: string}&StripeObject) $outcome Details about whether the payment was accepted, and why. See <a href="https://docs.stripe.com/declines">understanding declines</a> for details.
 ...
 * @property null|(object{amount: null|int, destination: Account|string}&StripeObject) $transfer_data An optional dictionary including the account to automatically transfer to as part of a destination charge. <a href="https://docs.stripe.com/connect/destination-charges">See the Connect documentation</a> for details.
