 ...
 * @property \Erikwang2013\Stripe\EventData\V2CoreAccountPersonUpdatedEventData $data data associated with the event
 */
class V2CoreAccountPersonUpdatedEvent extends \Erikwang2013\Stripe\V2\Core\Event
{
    ...
    public static function constructFrom($values, $opts = null, $apiMode = 'v2')
    {
        ...
        if (null !== $evt->data) {
            $evt->data = \Erikwang2013\Stripe\EventData\V2CoreAccountPersonUpdatedEventData::constructFrom($evt->data, $opts, $apiMode);
        }
