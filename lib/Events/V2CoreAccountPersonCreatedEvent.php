 ...
 * @property \Erikwang2013\Stripe\EventData\V2CoreAccountPersonCreatedEventData $data data associated with the event
 */
class V2CoreAccountPersonCreatedEvent extends \Erikwang2013\Stripe\V2\Core\Event
{
    ...
    public static function constructFrom($values, $opts = null, $apiMode = 'v2')
    {
        ...
        if (null !== $evt->data) {
            $evt->data = \Erikwang2013\Stripe\EventData\V2CoreAccountPersonCreatedEventData::constructFrom($evt->data, $opts, $apiMode);
        }
