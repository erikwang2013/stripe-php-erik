...
class SubscriptionService extends AbstractService
{
     ...
     *
     * @return \Erikwang2013\Stripe\Collection<\Erikwang2013\Stripe\Subscription>
     *
     ...
     * @param null|RequestOptionsArray|\Erikwang2013\Stripe\Util\RequestOptions $opts
     *
     * @return \Erikwang2013\Stripe\Subscription
     *
     * @throws \Erikwang2013\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * paid or marked uncollectible. If the invoice isn’t paid by the expiration date,
     * it is voided and the subscription remains <code>paused</code>. You can only
     * resume subscriptions with <code>collection_method</code> set to
     * <code>charge_automatically</code>. <code>send_invoice</code> subscriptions are
     * not supported.
     *
     * @param string $id
     ...
     * @param null|RequestOptionsArray|\Erikwang2013\Stripe\Util\RequestOptions $opts
     *
     * @return \Erikwang2013\Stripe\SearchResult<\Erikwang2013\Stripe\Subscription>
     *
     * @throws \Erikwang2013\Stripe\Exception\ApiErrorException if the request fails
     */
