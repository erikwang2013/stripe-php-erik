...
class TransferService extends AbstractService
{
     ...
     *
     * @return \Erikwang2013\Stripe\Collection<\Erikwang2013\Stripe\Transfer>
     *
     ...
     * @param null|RequestOptionsArray|\Erikwang2013\Stripe\Util\RequestOptions $opts
     *
     * @return \Erikwang2013\Stripe\Collection<\Erikwang2013\Stripe\TransferReversal>
     *
     * @throws \Erikwang2013\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\Erikwang2013\Stripe\Util\RequestOptions $opts
     *
     * @return \Erikwang2013\Stripe\Transfer
     *
     * @throws \Erikwang2013\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\Erikwang2013\Stripe\Util\RequestOptions $opts
     *
     * @return \Erikwang2013\Stripe\TransferReversal
     *
     * @throws \Erikwang2013\Stripe\Exception\ApiErrorException if the request fails
     */
