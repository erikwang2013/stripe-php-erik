...
class PriceService extends AbstractService
{
     ...
     *
     * @return \Erikwang2013\Stripe\Collection<\Erikwang2013\Stripe\Price>
     *
     ...
     * @param null|RequestOptionsArray|\Erikwang2013\Stripe\Util\RequestOptions $opts
     *
     * @return \Erikwang2013\Stripe\Price
     *
     * @throws \Erikwang2013\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\Erikwang2013\Stripe\Util\RequestOptions $opts
     *
     * @return \Erikwang2013\Stripe\SearchResult<\Erikwang2013\Stripe\Price>
     *
     * @throws \Erikwang2013\Stripe\Exception\ApiErrorException if the request fails
     */
