...
class ApplicationFeeService extends AbstractService
{
     ...
     *
     * @return \Erikwang2013\Stripe\Collection<\Erikwang2013\Stripe\ApplicationFee>
     *
     ...
     * @param null|RequestOptionsArray|\Erikwang2013\Stripe\Util\RequestOptions $opts
     *
     * @return \Erikwang2013\Stripe\Collection<\Erikwang2013\Stripe\ApplicationFeeRefund>
     *
     * @throws \Erikwang2013\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\Erikwang2013\Stripe\Util\RequestOptions $opts
     *
     * @return \Erikwang2013\Stripe\ApplicationFeeRefund
     *
     * @throws \Erikwang2013\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\Erikwang2013\Stripe\Util\RequestOptions $opts
     *
     * @return \Erikwang2013\Stripe\ApplicationFee
     *
     * @throws \Erikwang2013\Stripe\Exception\ApiErrorException if the request fails
     */
