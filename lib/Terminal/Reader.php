 ...
 * @property null|(object{collect_inputs?: (object{inputs: ((object{custom_text: null|(object{description: null|string, skip_button: null|string, submit_button: null|string, title: null|string}&\Erikwang2013\Stripe\StripeObject), email?: (object{value: null|string}&\Erikwang2013\Stripe\StripeObject), numeric?: (object{value: null|string}&\Erikwang2013\Stripe\StripeObject), phone?: (object{value: null|string}&\Erikwang2013\Stripe\StripeObject), required: null|bool, selection?: (object{choices: ((object{id: null|string, style: null|string, text: string}&\Erikwang2013\Stripe\StripeObject))[], id: null|string, text: null|string}&\Erikwang2013\Stripe\StripeObject), signature?: (object{value: null|string}&\Erikwang2013\Stripe\StripeObject), skipped?: bool, text?: (object{value: null|string}&\Erikwang2013\Stripe\StripeObject), toggles: null|((object{default_value: null|string, description: null|string, title: null|string, value: null|string}&\Erikwang2013\Stripe\StripeObject))[], type: string}&\Erikwang2013\Stripe\StripeObject))[], metadata: null|\Erikwang2013\Stripe\StripeObject}&\Erikwang2013\Stripe\StripeObject), collect_payment_method?: (object{collect_config?: (object{enable_customer_cancellation?: bool, skip_tipping?: bool, tipping?: (object{amount_eligible?: int}&\Erikwang2013\Stripe\StripeObject)}&\Erikwang2013\Stripe\StripeObject), payment_intent: string|\Erikwang2013\Stripe\PaymentIntent, payment_method?: \Erikwang2013\Stripe\PaymentMethod}&\Erikwang2013\Stripe\StripeObject), confirm_payment_intent?: (object{confirm_config?: (object{return_url?: string}&\Erikwang2013\Stripe\StripeObject), payment_intent: string|\Erikwang2013\Stripe\PaymentIntent}&\Erikwang2013\Stripe\StripeObject), failure_code: null|string, failure_message: null|string, process_payment_intent?: (object{payment_intent: string|\Erikwang2013\Stripe\PaymentIntent, process_config?: (object{enable_customer_cancellation?: bool, return_url?: string, skip_tipping?: bool, tipping?: (object{amount_eligible?: int}&\Erikwang2013\Stripe\StripeObject)}&\Erikwang2013\Stripe\StripeObject)}&\Erikwang2013\Stripe\StripeObject), process_setup_intent?: (object{generated_card?: string, process_config?: (object{enable_customer_cancellation?: bool}&\Erikwang2013\Stripe\StripeObject), setup_intent: string|\Erikwang2013\Stripe\SetupIntent}&\Erikwang2013\Stripe\StripeObject), refund_payment?: (object{amount?: int, charge?: string|\Erikwang2013\Stripe\Charge, metadata?: \Erikwang2013\Stripe\StripeObject, payment_intent?: string|\Erikwang2013\Stripe\PaymentIntent, reason?: string, refund?: string|\Erikwang2013\Stripe\Refund, refund_application_fee?: bool, refund_payment_config?: (object{enable_customer_cancellation?: bool}&\Erikwang2013\Stripe\StripeObject), reverse_transfer?: bool}&\Erikwang2013\Stripe\StripeObject), set_reader_display?: (object{cart: null|(object{currency: string, line_items: (object{amount: int, description: string, quantity: int}&\Erikwang2013\Stripe\StripeObject)[], tax: null|int, total: int}&\Erikwang2013\Stripe\StripeObject), type: string}&\Erikwang2013\Stripe\StripeObject), status: string, type: string}&\Erikwang2013\Stripe\StripeObject) $action The most recent action performed by the reader.
 ...
 */
class Reader extends \Erikwang2013\Stripe\ApiResource
{
    ...
    const DEVICE_TYPE_SIMULATED_STRIPE_S710 = 'simulated_stripe_s710';
    ...
    const DEVICE_TYPE_STRIPE_S710 = 'stripe_s710';
     ...
     * @param null|array|string $opts
     *
     * @return \Erikwang2013\Stripe\Collection<Reader> of ApiResources
     *
     * @throws \Erikwang2013\Stripe\Exception\ApiErrorException if the request fails
     */
